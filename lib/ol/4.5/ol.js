...
(function (root, factory) {
	...
	(this, function () {
		...
		var ea = 0;
		function ha(a) {
			this.message = "Assertion failed. See https://openlayers.org/en/v4.5.0/doc/errors/#" + a + " for details.";
			this.code = a;
		...
		function ja(a, b, c, d, e) {
			return void 0 !== e ? (e.fa = a, e.la = b, e.ea = c, e.ka = d, e) : new ia(a, b, c, d)
		}
		function ka(a, b, c) {
		...
		function Ba(a) {
			for (var b = Ca(), c = 0, d = a.length; c < d; ++c)
				Da(b, a[c]);
			return b
		}
		function Ea(a, b, c) {
		...
		function Na(a) {
			return Ma(Infinity, Infinity, -Infinity, -Infinity, a)
		}
		function Oa(a, b) {
			var c = a[0];
			a = a[1];
		...
		function Ua(a, b, c) {
			var d;
			return (d = b.call(c, Va(a))) || (d = b.call(c, Wa(a))) || (d = b.call(c, Xa(a))) ? d : (d = b.call(c, Ya(a))) ? d : !1
		}
		function Za(a) {
			var b = 0;
			$a(a) || (b = ab(a) * bb(a));
		...
		function db(a, b, c, d, e) {
			...
			var n = m + f + b;
			f = m + f - b;
			return Ma(Math.min(a, d, g, c), Math.min(h, l, n, f), Math.max(a, d, g, c), Math.max(h, l, n, f), e)
		}
		function bb(a) {
			return a[3] - a[1]
		}
		function eb(a, b, c) {
			c = c ? c : Ca();
			fb(a, b) && (c[0] = a[0] > b[0] ? a[0] : b[0], c[1] = a[1] > b[1] ? a[1] : b[1], c[2] = a[2] < b[2] ? a[2] : b[2], c[3] = a[3] < b[3] ? a[3] : b[3]);
			return c
		}
		function Ya(a) {
			return [a[0], a[3]]
		...
		var jb = "function" === typeof Object.assign ? Object.assign : function (a, b) {
			if (void 0 === a || null === a)
		...
		nb.prototype.a = function (a) {
			return ob(a, this.radius)
		};
		nb.prototype.b = function (a, b) {
			return pb(a, b, this.radius)
		};
		nb.prototype.offset = function (a, b, c) {
			var d = ua(a[1]);
			b /= this.radius;
			var e = Math.asin(Math.sin(d) * Math.cos(b) + Math.cos(d) * Math.sin(b) * Math.cos(c));
			return [180 * (ua(a[0]) + Math.atan2(Math.sin(c) * Math.sin(b) * Math.cos(d), Math.cos(b) - Math.sin(d) * Math.sin(e))) / Math.PI, 180 * e / Math.PI]
		};
		function qb(a, b) {
			var c = b || {},
		...
		function Cb(a, b, c) {
			...
			void 0 === b && (2 < c ? b = a.slice() : b = Array(d));
			for (var e = 0; e < d; e += c)
				b[e] = 180 * a[e] / zb, b[e + 1] = 360 * Math.atan(Math.exp(a[e + 1] / 6378137)) / Math.PI - 90;
			return b
		};
		function Db(a, b) {
			vb.call(this, {
		...
		function Mb(a, b, c, d) {
			a = Nb(a);
			var e = a.j;
			e ? b = e(b, c) : "degrees" == a.a && !d || "degrees" == d || (e = Ob(a, Nb("EPSG:4326")), b = [c[0] - b / 2, c[1], c[0] + b / 2, c[1], c[0], c[1] - b / 2, c[0], c[1] + b / 2], b = e(b, b, 2), b = (Lb.b(b.slice(0, 2), b.slice(2, 4)) + Lb.b(b.slice(4, 6), b.slice(6, 8))) / 2, a = d ? tb[d] : a.Wc(), void 0 !== a && (b /= a));
			return b
		}
		function Pb(a) {
			a.forEach(Qb);
		...
		function Tb(a) {
			return a ? "string" === typeof a ? Nb(a) : a : Nb("EPSG:3857")
		}
		function Ub(a, b, c, d) {
			a = Nb(a);
			b = Nb(b);
		...
		function Nb(a) {
			...
			if (a instanceof vb)
				b = a;
			else if ("string" === typeof a && (b = Hb[a] || null, !b)) {
				var c = ub || window.proj4;
				"function" == typeof c && void 0 !== c.defs(a) && (b = new vb({
							code: a
						}), Qb(b))
			}
			return b
		...
		function Wb(a, b) {
			if (a === b)
				return !0;
			var c = a.a === b.a;
			return a.ub === b.ub ? c : Ob(a, b) === Rb && c
		}
		function Xb(a, b) {
			a = Nb(a);
			b = Nb(b);
		...
		function Zb(a, b, c) {
			return Xb(b, c)(a, void 0, a.length)
		}
		function $b(a, b, c) {
			b = Xb(b, c);
			return hb(a, b)
		...
		function qc(a) {
			...
			void 0 !== a.sizes ? this.a = a.sizes.map(function (a) {
					return new ia(Math.min(0, a[0]), Math.max(a[0] - 1, -1), Math.min(0, a[1]), Math.max(a[1] - 1, -1))
				}, this) : d && rc(this, d)
		}
		var sc = [0, 0, 0];
		k = qc.prototype;
		...
		function uc(a, b, c, d, e) {
			...
			if (2 === a.l) {
				...
				f = a.La(b, e);
			for (; g >= a.minZoom; ) {
				2 === a.l ? (h = Math.floor(h / 2), l = Math.floor(l / 2), b = ja(h, h, l, l, d)) : b = tc(a, f, g, d);
				if (c.call(null, g, b))
					return !0;
				--g
			}
		...
		function vc(a, b, c, d) {
			if (b[0] < a.maxZoom) {
				if (2 === a.l)
					return a = 2 * b[1], b = 2 * b[2], ja(a, a + 1, b, b + 1, c);
				d = a.La(b, d);
		...
		function wc(a, b, c) {
			...
			e = a.Sa(b);
			a = Aa(a.Za(b), a.f);
			return Ma(d[0] + c.fa * a[0] * e, d[1] + c.ea * a[1] * e, d[0] + (c.la + 1) * a[0] * e, d[1] + (c.ka + 1) * a[1] * e, void 0)
		}
		function tc(a, b, c, d) {
			xc(a, b[0], b[1], c, !1, sc);
			var e = sc[1],
		...
		k.La = function (a, b) {
			...
			f = c[0] + a[1] * e[0] * d;
			a = c[1] + a[2] * e[1] * d;
			return Ma(f, a, f + e[0] * d, a + e[1] * d, b)
		};
		k.Ke = function (a, b, c) {
			var d = a[0],
			e = a[1];
		...
		k.Bc = function (a, b) {
			return oa(dc(this.b, a, b || 0), this.minZoom, this.maxZoom)
		};
		function rc(a, b) {
		...
		function Dc(a) {
			a = Nb(a);
			var b = a.C();
			b || (a = 180 * tb.degrees / a.Wc(), b = Ma(-a, -a, a, a));
			return b
		};
		function Ec(a) {
			this.mg = a.html
		...
		function Hc(a, b, c, d) {
			for (var e, f = 0, g = a.length; f < g; ++f)
				if (e = a[f], e.listener === b && e.Ah === c)
					return d && (e.deleteIndex = f), e
		}
		function Ic(a, b) {
			return (a = a.mb) ? a[b] : void 0
		}
		function Jc(a) {
			var b = a.mb;
			b || (b = a.mb = {});
		...
		function Kc(a, b) {
			...
			if (c) {
				for (var d = 0, e = c.length; d < e; ++d)
					a.removeEventListener(b, c[d].Bh), kb(c[d]);
				c.length = 0;
				if (c = a.mb)
					delete c[b], 0 === Object.keys(c).length && delete a.mb
			}
		}
		...
		k.get = function (a) {
			var b;
			this.P.hasOwnProperty(a) && (b = this.P[a]);
			return b
		};
		k.R = function () {
			return Object.keys(this.P)
		};
		k.M = function () {
			return jb({}, this.P)
		};
		...
		k.set = function (a, b, c) {
			c ? this.P[a] = b : (c = this.P[a], this.P[a] = b, c !== b && Yc(this, a, c))
		};
		k.I = function (a, b) {
			for (var c in a)
				this.set(c, a[c], b)
		...
		k.Hm = function (a) {
			this.b.b(new Ld("lostpointercapture", a, a))
		};
		k.Gm = function (a) {
			this.b.b(new Ld("gotpointercapture", a, a))
		};
		function Md(a) {
			Bd.call(this, a, {
				pointerdown: this.Bp,
				...
				pointerout: this.Dp,
				pointerover: this.Ep,
				pointercancel: this.Ap,
				gotpointercapture: this.Nl,
				lostpointercapture: this.ym
			})
		}
		v(Md, Bd);
		k = Md.prototype;
		...
		k.$h = function (a) {
			...
			this.b(b);
			!this.l && 0 === a.button && de(this, this.c);
		...
		le.prototype.l = function (a) {
			...
			var b = a.getState();
			if (2 === b || 3 === b || 4 === b || 5 === b)
				Mc(a, "change", this.l, this), a = a.ib(), a in this.f && (delete this.f[a], --this.j), this.v()
		};
		function me(a, b, c) {
			for (var d = 0, e = !1, f, g, h; a.j < b && d < c && 0 < a.b.length; )
				g = he(a)[0], h = g.ib(), f = g.getState(), 5 === f ? e = !0 : 0 !== f || h in a.f || (a.f[h] = !0, ++a.j, ++d, g.load());
			0 === d && e && a.v()
		};
		function ne(a) {
			return function (b) {
				if (b)
					return [oa(b[0], a[0], a[2]), oa(b[1], a[1], a[3])]
			}
		}
		function oe(a) {
			return a
		...
		function pe(a) {
			return function (b, c, d) {
				if (void 0 !== b)
					return b = dc(a, b, d), b = oa(b + c, 0, a.length - 1), c = Math.floor(b), b != c && c < a.length - 1 ? a[c] / Math.pow(a[c] / a[c + 1], b - c) : a[c]
			}
		}
		function qe(a, b, c) {
		...
		k.Zc = Re;
		k.C = function (a) {
			this.v != this.g && (this.s = this.ze(this.s), this.v = this.g);
			var b = this.s;
		...
		k.Zc = Re;
		k.ze = function (a) {
			return Pa(this.A, 0, this.A.length, this.a, a)
		};
		k.ec = function () {
		...
		k.Vd = function (a) {
			this.l != this.g && (kb(this.i), this.f = 0, this.l = this.g);
		...
		function uf(a, b, c, d, e, f, g, h, l, m, n) {
			...
			for (var q = n ? n : [NaN, NaN], r = b + d; r < c; )
				if (nf(a, r - d, r, d, g, h, q), p = ta(g, h, q[0], q[1]), p < m) {
					m = p;
					for (n = 0; n < d; ++n)
						l[n] = q[n];
					l.length = d;
			...
			if (f && (nf(a, c - d, b, d, g, h, q), p = ta(g, h, q[0], q[1]), p < m)) {
				m = p;
				for (n = 0; n < d; ++n)
					l[n] = q[n];
				l.length = d
		...
		function vf(a, b, c, d, e, f, g, h, l, m, n) {
			n = n ? n : [NaN, NaN];
			var p;
			var q = 0;
		...
		k.Nb = function (a, b, c, d) {
			...
			return uf(this.A, 0, this.A.length, this.a, this.j, !0, a, b, c, d)
		};
		k.Mn = function () {
			return lf(this.A, 0, this.A.length, this.a)
		};
		k.U = function () {
			return zf(this.A, 0, this.A.length, this.a)
		};
		k.vd = function (a) {
			var b = [];
		...
		k.$a = function () {};
		k.na = function (a, b) {
			a ? (kf(this, b, a, 1), this.A || (this.A = []), this.A.length = xf(this.A, 0, a, this.a), this.u()) : Ff(this, "XY", null)
		};
		function Ff(a, b, c) {
			jf(a, b, c);
			a.u()
		...
		k.$a = function (a) {
			return Ia(a, this.A[0], this.A[1])
		};
		k.na = function (a, b) {
			a ? (kf(this, b, a, 0), this.A || (this.A = []), this.A.length = wf(this.A, a), this.u()) : this.ba("XY", null)
		};
		k.ba = function (a, b) {
			jf(this, a, b);
			this.u()
		...
		function If(a, b, c, d, e, f) {
			if (0 === c.length || !Hf(a, b, c[0], d, e, f))
				return !1;
			var g;
			b = 1;
			for (g = c.length; b < g; ++b)
				if (Hf(a, c[b - 1], c[b], d, e, f))
					return !1;
			return !0
		};
		...
		function Lf(a, b, c, d, e) {
			var f = Qa(Ca(), a, b, c, d);
			return fb(e, f) ? Ka(e, f) || f[0] >= e[0] && f[2] <= e[2] || f[1] >= e[1] && f[3] <= e[3] ? !0 : Kf(a, b, c, d, function (a, b) {
				var c = !1,
				d = La(e, a),
				f = La(e, b);
				if (1 === d || 1 === f)
		...
		function Mf(a, b, c, d, e) {
			var f = c[0];
			if (!(Lf(a, b, f, d, e) || Hf(a, b, f, d, e[0], e[1]) || Hf(a, b, f, d, e[0], e[3]) || Hf(a, b, f, d, e[2], e[1]) || Hf(a, b, f, d, e[2], e[3])))
				return !1;
			if (1 === c.length)
				return !0;
			b = 1;
			for (f = c.length; b < f; ++b)
				if (Gf(a, c[b - 1], c[b], d, e))
					return !1;
			return !0
		};
		function Nf(a, b, c, d) {
		...
		k = D.prototype;
		k.Ck = function (a) {
			this.A ? ec(this.A, a.da()) : this.A = a.da().slice();
		...
		k.Nb = function (a, b, c, d) {
			if (d < Ga(this.C(), a, b))
				return d;
			this.B != this.g && (this.H = Math.sqrt(tf(this.A, 0, this.c, this.a, 0)), this.B = this.g);
			return vf(this.A, 0, this.c, this.a, this.H, !0, a, b, c, d)
		};
		k.Zc = function (a, b) {
			return If(this.Xb(), 0, this.c, this.a, a, b)
		};
		k.Pn = function () {
			return mf(this.Xb(), 0, this.c, this.a)
		};
		k.U = function (a) {
			if (void 0 !== a) {
				var b = this.Xb().slice();
				Pf(b, 0, this.c, this.a, a)
			} else
				b = this.A;
		...
		k.Th = function (a) {
			if (0 > a || this.c.length <= a)
				return null;
			var b = new Ef(null);
			Ff(b, this.ja, this.A.slice(0 === a ? 0 : this.c[a - 1], this.c[a]));
			return b
		};
		k.Td = function () {
			var a = this.ja,
		...
		k.$a = function (a) {
			return Mf(this.Xb(), 0, this.c, this.a, a)
		};
		k.na = function (a, b) {
			a ? (kf(this, b, a, 2), this.A || (this.A = []), a = yf(this.A, 0, a, this.a, this.c), this.A.length = 0 === a.length ? 0 : a[a.length - 1], this.u()) : this.ba("XY", null, this.c)
		};
		k.ba = function (a, b, c) {
			jf(this, a, b);
			this.c = c;
		...
		function Rf(a, b, c, d) {
			...
			var f;
			for (f = 0; f < e; ++f)
				ec(d, a.offset(b, c, 2 * Math.PI * f / e));
			d.push(d[0], d[1]);
			a = new D(null);
			a.ba("XY", d, [d.length]);
			return a
		...
		function Xf(a, b, c, d) {
			...
			for (var m, n, p = 0; p <= l; ++p)
				n = p * g, m = d + 2 * va(p, l) * Math.PI / l, e[n] = b[0] + c * Math.cos(m), e[n + 1] = b[1] + c * Math.sin(m);
			a.ba(f, e, h)
		};
		function F(a) {
			Vc.call(this);
		...
		k.animate = function (a) {
			...
			if ($f(this)) {
				...
				b = arguments[b - 1], b.center && this.tb(b.center), void 0 !== b.zoom && this.Oj(b.zoom), void 0 !== b.rotation && this.ae(b.rotation), c && c(!0)
		};
		k.zc = function () {
			return 0 < this.i[0]
		};
		...
		k.constrainResolution = function (a, b, c) {
			return this.j.resolution(a, b || 0, c || 0)
		};
		k.constrainRotation = function (a, b) {
			return this.j.rotation(a, b || 0)
		};
		k.wa = function () {
		...
		k.Ie = function (a, b) {
			b = b || dg(this);
			return Math.max(ab(a) / b[0], bb(a) / b[1])
		};
		function eg(a) {
			var b = a.a,
		...
		k.Le = function (a) {
			...
			if (this.l) {
				...
				b += c;
				var d = this.l[c];
				c = c == this.l.length - 1 ? 2 : d / this.l[c + 1]
			} else
				d = this.a, c = this.D;
		...
		k.Sf = function (a, b) {
			...
			if (a instanceof gf)
				if ("Circle" === a.T()) {
					a = a.C();
					var d = Sf(a);
					d.rotate(this.Ra(), cb(a))
				} else
					d = a;
			else
				na(Array.isArray(a), 24), na(!$a(a), 25), d = Sf(a);
			...
			this.animate({
				...
				duration: b.duration,
				easing: b.easing
			}, e) : (this.fd(c), this.tb(a), setTimeout(e.bind(void 0, !0), 0))
		};
		k.Ik = function (a, b, c) {
			var d = this.Ra(),
			e = Math.cos(-d);
		...
		function $f(a) {
			return !!a.wa() && void 0 !== a.Qa()
		}
		k.rotate = function (a, b) {
			void 0 !== b && (b = cg(this, a, b), this.tb(b));
			this.ae(a)
		};
		k.tb = function (a) {
			this.set("center", a);
		...
		function kg(a) {
			a.a.opacity = oa(a.mc(), 0, 1);
			a.a.Qj = a.fg();
			a.a.visible = a.Jb();
			a.a.extent = a.C();
			a.a.zIndex = a.Ba();
			a.a.maxResolution = a.kc();
			a.a.minResolution = Math.max(a.lc(), 0);
			return a.a
		}
		k.C = function () {
		...
		function lg(a) {
			...
			b ? Array.isArray(b) ? b = new A(b.slice(), {
					unique: !0
				}) : na(b instanceof A, 43) : b = new A(void 0, {
					unique: !0
				});
			this.Ni(b)
		}
		...
		k.$l = function () {
			...
			this.i.length = 0;
			var a = this.Ad();
			this.i.push(y(a, "add", this.Zl, this), y(a, "remove", this.am, this));
			for (var b in this.c)
				this.c[b].forEach(Gc);
			kb(this.c);
			a = a.a;
		...
		k.bg = function (a) {
			...
			for (d = b.length; c < d; c++) {
				...
				void 0 !== a.extent && (e.extent = void 0 !== e.extent ? eb(e.extent, a.extent) : a.extent)
			}
			return b
		};
		k.fg = function () {
		...
		k.Sc = function (a, b, c) {
			if (this.c)
				return a = this.Pa(a), c = void 0 !== c ? c : {},
			this.oc.Ga(a, this.c, void 0 !== c.hitTolerance ? c.hitTolerance * this.c.pixelRatio : 0, b, null, void 0 !== c.layerFilter ? c.layerFilter : Qe, null)
		};
		k.Vf = function (a, b) {
			var c = null;
			this.Sc(a, function (a) {
				c || (c = []);
				c.push(a)
			}, b);
			return c
		};
		k.rg = function (a, b, c, d, e) {
			if (this.c)
				return this.oc.Qi(a, this.c, b, void 0 !== c ? c : null, void 0 !== d ? d : Qe, void 0 !== e ? e : null)
		};
		k.lg = function (a, b) {
			if (!this.c)
				return !1;
			a = this.Pa(a);
			b = void 0 !== b ? b : {};
			return this.oc.Ri(a, this.c, void 0 !== b.hitTolerance ? b.hitTolerance * this.c.pixelRatio : 0, void 0 !== b.layerFilter ? b.layerFilter : Qe, null)
		};
		k.Rd = function (a) {
			return this.Pa(this.sd(a))
		};
		k.sd = function (a) {
		...
		k.Mc = function () {
			...
			if (a) {
				...
				this.ge([a.offsetWidth - parseFloat(b.borderLeftWidth) - parseFloat(b.paddingLeft) - parseFloat(b.paddingRight) - parseFloat(b.borderRightWidth), a.offsetHeight - parseFloat(b.borderTopWidth) - parseFloat(b.paddingTop) - parseFloat(b.paddingBottom) - parseFloat(b.borderBottomWidth)])
			} else
				this.ge(void 0)
		};
		k.Uj = function (a) {
		...
		function rg(a) {
			...
			if (void 0 === a.logo || "boolean" === typeof a.logo && a.logo)
				...
				var e = a.logo;
				"string" === typeof e ? d[e] = "" : e instanceof HTMLElement ? d[w(e).toString()] = e : e && (na("string" == typeof e.href, 44), na("string" == typeof e.src, 45), d[e.src] = e.href)
			}
			e = a.layers instanceof lg ? a.layers : new lg({
					layers: a.layers
				});
			c.layergroup = e;
			c.target = a.target;
			...
			var g =
				f.length;
			a: for (; e < g; ++e)
				for (var h = f[e], l = 0, m = ng.length; l < m; ++l) {
					var n = ng[l];
					if (n.handles(h)) {
						var p = n;
						break a
			...
			if (void 0 !== a.controls)
				if (Array.isArray(a.controls))
					var q = new A(a.controls.slice());
				else
					na(a.controls instanceof A, 47), q = a.controls;
			if (void 0 !== a.interactions)
				if (Array.isArray(a.interactions))
					var r = new A(a.interactions.slice());
				else
					na(a.interactions instanceof A, 48), r = a.interactions;
		...
		tg.prototype.setMap = function (a) {
			this.a && ig(this.element);
			for (var b = 0, c = this.s.length; b < c; ++b)
				Gc(this.s[b]);
			this.s.length = 0;
			if (this.a = a)
				(this.G ? this.G : a.v).appendChild(this.element), this.render !== da && this.s.push(y(a, "postrender", this.render, this)), a.render()
		};
		tg.prototype.i = function (a) {
			this.G = "string" === typeof a ? document.getElementById(a) : a
		};
		var ug = function () {
			var a,
			b = {};
		...
		function yg(a) {
			if (a = a.frameState) {
				for (var b = {}, c = [], d = a.layerStatesArray, e = a.viewState.resolution, f = 0, g = d.length; f < g; ++f) {
					var h = d[f];
					if (wg(h, e) && (h = h.layer.ia()) && (h = h.B) && (h = h(a)))
						if (Array.isArray(h))
				...
				this.B && (this.element.style.display = "none", this.B = !1)
		}
		k = xg.prototype;
		k.rn = function (a) {
			a.preventDefault();
		...
		k.tn = function (a) {
			this.j !== a && (this.j = a, this.element.classList.toggle("ol-uncollapsible"), !a && this.c && zg(this))
		};
		k.sn = function (a) {
			this.j && this.c !== a && zg(this)
		};
		k.pn = function () {
			return this.c
		};
		...
		v(Ag, tg);
		Ag.prototype.D = function (a) {
			a.preventDefault();
			void 0 !== this.l ? this.l() : (a = this.a.$()) && void 0 !== a.Ra() && (0 < this.v ? a.animate({
					rotation: 0,
					duration: this.v,
					easing: Ne
				}) : a.ae(0))
		...
		Cg.prototype.j = function (a, b) {
			...
			if (b = this.a.$()) {
				var c = b.Qa();
				c && (a = b.constrainResolution(c, a), 0 < this.c ? (b.zc() && b.pd(), b.animate({
							resolution: a,
							duration: this.c,
							easing: Ne
						})) : b.fd(a))
		...
		function Dg(a) {
			...
			(void 0 !== a.attribution ? a.attribution : 1) && b.push(new xg(a.attributionOptions));
			return b
		};
		function Eg(a, b, c) {
			this.i = a;
		...
		Hg.prototype.Ha = function (a) {
			this.set("active", a)
		};
		Hg.prototype.setMap = function (a) {
			this.v = a
		};
		function Ig(a, b, c, d) {
			if (void 0 !== b) {
		...
		function dh(a) {
			a = a ? a : {};
			Hg.call(this, {
				handleEvent: a.handleEvent ? a.handleEvent : eh
			});
		...
		function eh(a) {
			...
			if ("pointerdown" === c || "pointerdrag" === c || "pointerup" === c) {
				...
				"pointerup" == a.type ? delete this.aa[d] : "pointerdown" == a.type ? this.aa[d] = c : d in this.aa && (this.aa[d] = c);
				this.l = lb(this.aa)
			}
			this.D ? "pointerdrag" == a.type ? this.zk(a) : "pointerup" == a.type && (this.D = this.Gk(a) && 0 < this.l.length) : "pointerdown" == a.type ? (this.D = a = this.Yj(a), b = this.hd(a)) : "pointermove" == a.type && this.Fk(a);
			return !b
		}
		dh.prototype.hd = function (a) {
			return a
		};
		function gh(a) {
			dh.call(this, {
		...
		function lh(a) {
			return bh(a) && Wg(a) && this.f(a) ? (ag(a.map.$(), 1, 1), this.a = void 0, !0) : !1
		}
		kh.prototype.hd = Re;
		function oh(a) {
			this.Tc = null;
		...
		oh.prototype.setMap = function (a) {
			if (this.b) {
		...
		function uh(a) {
			if (!bh(a))
				return !0;
			this.a.setMap(null);
			this.s(a, this.f, a.pixel) && (this.j(a), this.b(new wh(yh, a.coordinate, a)));
			return !1
		}
		function sh(a) {
			if (bh(a) && Wg(a) && this.B(a)) {
				this.f = a.pixel;
				this.a.setMap(a.map);
				var b = this.a,
				c = this.f;
				...
				qh(b);
				ph(b);
				this.b(new wh(zh, a.coordinate, a));
				return !0
			}
			return !1
		}
		...
		function Ah(a) {
			a = a ? a : {};
			var b = a.condition ? a.condition : $g;
		...
		function Ch(a) {
			...
			if ("keydown" == a.type) {
				...
				if (this.f(a) && (40 == c || 37 == c || 39 == c || 38 == c)) {
					...
					c = this.j;
					if (e = b.wa())
						d = b.Qc([e[0] + d[0], e[1] + d[1]]), c ? b.animate({
							duration: c,
							easing: Pe,
							center: d
						}) : b.tb(d);
		...
		function Kh(a) {
			...
			if ("keydown" == a.type || "keypress" == a.type) {
				...
				!this.f(a) || 43 != c && 45 != c || (b = 43 == c ? this.a : -this.a, c = a.map.$(), Qg(c, b, void 0, this.j), a.preventDefault(), b = !0)
			}
			return !b
		};
		function Lh(a) {
		...
		function Qh(a) {
			return 2 <= this.l.length ? (a = a.map, this.f = null, this.j = void 0, this.a = !1, this.s = 0, this.D || ag(a.$(), 1, 1), !0) : !1
		}
		Ph.prototype.hd = Re;
		function Th(a) {
			dh.call(this, {
		...
		function Uh(a) {
			return 2 <= this.l.length ? (a = a.map, this.f = null, this.a = void 0, this.j = 1, this.D || ag(a.$(), 1, 1), !0) : !1
		}
		Th.prototype.hd = Re;
		function Xh(a) {
			a = a ? a : {};
			...
			(void 0 !== a.doubleClickZoom ? a.doubleClickZoom : 1) && b.push(new Sg({
					delta: a.zoomDelta,
					duration: a.zoomDuration
				}));
			(void 0 !== a.dragPan ? a.dragPan : 1) && b.push(new gh({
					kinetic: c
				}));
			(void 0 !== a.pinchRotate ? a.pinchRotate : 1) && b.push(new Ph);
			(void 0 !== a.pinchZoom ? a.pinchZoom : 1) && b.push(new Th({
					constrainResolution: a.constrainResolution,
					duration: a.zoomDuration
				}));
			if (void 0 !== a.keyboard ?
				a.keyboard : 1)
				b.push(new Bh), b.push(new Dh({
						delta: a.zoomDelta,
						duration: a.zoomDuration
					}));
			(void 0 !== a.mouseWheelZoom ? a.mouseWheelZoom : 1) && b.push(new Lh({
					constrainResolution: a.constrainResolution,
					duration: a.zoomDuration
				}));
		...
		k.forEach = function (a, b) {
			for (var c = this.g; c; )
				a.call(b, c.Nc, c.ic, this), c = c.hb
		};
		k.get = function (a) {
			a = this.a[a];
			na(void 0 !== a, 15);
		...
		ei = {},
			...
			function a(a) {
				e || (e = gg(1, 1), e.font = "32px monospace", g = e.measureText("wmytzilWMYTZIL@#/&?$%10").width);
				var b = !0;
				"monospace" != a && (e.font = "32px " + a + ",monospace", b = e.measureText("wmytzilWMYTZIL@#/&?$%10").width != g, e.font = "32px monospace");
				return b
			}
			function b() {
				var b = !0,
				e;
				for (e in c)
					60 > c[e] && (a(e) ? (c[e] = 60, d.clear()) : (++c[e], b = !1));
		...
		var hi = Ve();
		function ii(a, b, c, d, e, f, g, h, l, m, n) {
			if (1 != c) {
				var p = a.globalAlpha;
				a.globalAlpha = p * c
			}
			...
			return function (c) {
				if (a.hasOwnProperty(c))
					...
					if (ji.exec(d)) {
						...
						0 == d.indexOf("rgba(") ? (d = d.slice(5, -1).split(",").map(Number), f = oi(d)) : 0 == d.indexOf("rgb(") ? (d = d.slice(4, -1).split(",").map(Number), d.push(1), f = oi(d)) : na(!1, 14);
					d = f;
					a[c] = d;
					++b
				}
		...
		function pi(a) {
			return "string" === typeof a || a instanceof CanvasPattern || a instanceof CanvasGradient ? a : ni(a)
		};
		function qi() {}
		k = qi.prototype;
		k.Eh = function () {};
		...
		function ti(a, b, c, d) {
			...
			if (a.qa && "" !== a.sa) {
				...
				h ? (h.font != f.font && (h.font = g.font = f.font), h.textAlign != l && (h.textAlign = l), h.textBaseline != f.textBaseline && (h.textBaseline = g.textBaseline = f.textBaseline)) : (g.font = f.font, g.textAlign = l, g.textBaseline = f.textBaseline, a.Va = {
						font: f.font,
						textAlign: l,
				...
				for (a.ya && (g += a.xb); e < c; e += d) {
					...
					l = b[e + 1] + a.Ub;
					if (0 !== g || 1 != a.s) {
						var m = df(a.nb, h, l, a.s, a.s, g, -h, -l);
		...
		k.cc = function (a) {
			if (fb(this.c, a.C())) {
				if (this.a || this.b) {
					this.a && ui(this, this.a);
					this.b && vi(this, this.b);
					var b = this.P;
					var c = this.o,
					d = a.da();
		...
		k.xc = function (a) {
			var b = a.da();
			a = a.pa();
			this.N && si(this, b, b.length);
			"" !== this.sa && ti(this, b, b.length, a)
		};
		k.vc = function (a) {
			var b = a.da();
			a = a.pa();
			...
			if (fb(this.c, b)) {
				if (this.b) {
					...
					for (g = e.length; h < g; ++h)
						d = wi(this, c, d, e[h], f, !1);
					b.stroke()
				}
				"" !== this.sa && (a = a.Fe(), ti(this, a, a.length, 2))
			}
		};
		k.yc = function (a) {
			if (fb(this.c, a.C())) {
		...
		k.wc = function (a) {
			if (fb(this.c, a.C())) {
				...
				"" !== this.sa && (a = zi(a), ti(this, a, a.length, 2))
			}
		};
		function ui(a, b) {
			var c = a.g,
			d = a.G;
			d ? d.fillStyle != b.fillStyle && (d.fillStyle = c.fillStyle = b.fillStyle) : (c.fillStyle = b.fillStyle, a.G = {
		...
		Ai.prototype.Ga = da;
		Ai.prototype.bf = Re;
		Ai.prototype.Pf = function (a, b, c) {
			return function (d, e) {
		...
		Ai.prototype.aa = function (a) {
			2 === a.target.getState() && Ci(this)
		};
		function Di(a, b) {
			var c = b.getState();
		...
		function Ei(a, b) {
			b.$i() && a.postRenderFunctions.push(function (a, b, e) {
				b = w(a).toString();
				b in e.usedTiles && a.qd(e.viewState.projection, e.usedTiles[b])
			}
				.bind(null, b))
		}
		function Fi(a, b) {
		...
		function Hi(a, b, c, d, e, f, g, h, l, m) {
			var n = w(b).toString();
		...
		Ii.prototype.v = function (a, b, c, d) {
			if (this.Ga(a, b, 0, Qe, this))
				return c.call(d, this.a, null)
		};
		Ii.prototype.mf = function (a, b, c, d) {
		...
		function Qi(a, b, c) {
			...
			e = b.pixelRatio,
			f = e / d.resolution;
			return df(a.W, e * b.size[0] / 2, e * b.size[1] / 2, f, -f, -d.rotation, -d.center[0] + c, -d.center[1])
		};
		function Ri(a) {
			Ii.call(this, a);
			this.s = Ve();
		...
		v(Ri, Ii);
		Ri.prototype.xg = function (a, b, c) {
			Pi(this, "precompose", c, a, void 0);
			var d = this.Y();
			if (d) {
				var e = b.extent,
		...
		Ri.prototype.Ga = function (a, b, c, d, e) {
			var f = this.a;
			return f.ia().Ga(a, b.viewState.resolution, b.viewState.rotation, c, b.skippedFeatureUids, function (a) {
				return d.call(e, a, f)
			})
		};
		Ri.prototype.v = function (a, b, c, d) {
			if (this.Y()) {
				if (this.a.ia().Ga !== da)
					return Ii.prototype.v.apply(this, arguments);
				var e = $e(this.s, a.slice());
		...
		v(Si, Ri);
		Si.handles = function (a, b) {
			return "canvas" === a && "IMAGE" === b.T()
		};
		Si.create = function (a, b) {
			return new Si(b)
		};
		...
		Si.prototype.Cd = function (a, b) {
			...
			this.N && (l = this.N, e = l.C(), b = l.resolution, l = l.a, m = c * b / (g * l), e = df(this.c, c * d[0] / 2, c * d[1] / 2, m, m, 0, l * (e[0] - f[0]) / b, l * (f[1] - e[3]) / b), df(this.s, c * d[0] / 2 - e[4], c * d[1] / 2 - e[5], c / g, -c / g, 0, -f[0], -f[1]), Fi(a, h), this.i = b * c / l);
			return !!this.N
		};
		function Ti() {
			this.b = {};
		...
		Ti.prototype.get = function (a, b, c) {
			a = b + ":" + a + ":" + (c ? ni(c) : "null");
			return a in this.b ? this.b[a] : null
		};
		Ti.prototype.set = function (a, b, c, d) {
			this.b[b + ":" + a + ":" + (c ? ni(c) : "null")] = d;
			++this.a
		};
		var Ui = new Ti;
		function Vi(a, b) {
		...
		k.Ga = function (a, b, c, d, e, f, g) {
			...
			for (q = p.length - 1; 0 <= q; --q) {
				var u = p[q];
				r = u.layer;
				if (wg(u, n) && f.call(g, r) && (u = Yi(this, r), r.ia() && (l = u.Ga(r.ia().D ? m : a, b, c, h, e)), l))
					return l
			}
		};
		k.Ri = function (a, b, c, d, e) {
			return void 0 !== this.Ga(a, b, c, Qe, this, d, e)
		};
		function Yi(a, b) {
			var c = w(b).toString();
			if (c in a.c)
				return a.c[c];
			for (var d, e = a.T(), f = 0, g = og.length; f < g; ++f) {
				var h = og[f];
				if (h.handles(e, b)) {
					d = h.create(a, b);
					break
			...
			if (d)
				a.c[c] = d, a.v[c] = y(d, "change", a.Yl, a);
			else
				throw Error("Unable to create renderer for layer: " + b.T());
			return d
		}
		k.Yl = function () {
			this.l.render()
		...
		function Zi(a, b) {
			for (var c in a.c)
				if (!(c in b.layerStates)) {
					b.postRenderFunctions.push(a.gq.bind(a));
					break
				}
		}
		function lc(a, b) {
		...
		$i.prototype.Qi = function (a, b, c, d, e, f) {
			...
			for (--l; 0 <= l; --l) {
				var m = h[l];
				var n = m.layer;
				if (wg(m, g) && e.call(f, n) && (m = Yi(this, n).v(a, b, c, d)))
					return m
			}
		};
		function bj(a) {
		...
		bj.prototype.Cd = function (a, b) {
			...
			for (Ja = x.fa; Ja <= x.la; ++Ja)
				for (ma = x.ea; ma <= x.ka; ++ma) {
					...
					if (cj(this, Sa)) {
						var N = w(this);
						if (2 == Sa.getState()) {
							E[p][Sa.xa.toString()] = Sa;
							var hc = Sa.j ? -1 !== Sa.s[N] : !1;
							pa || !hc && -1 !== this.f.indexOf(Sa) || (pa = !0)
						}
						if (1 === fj(Sa, N, a.time))
							continue
					}
			...
			if (!(this.i && 16 < Date.now() - a.time && Sa || !pa && this.c && Ka(this.c, u) && this.uf == m && r == this.B && (Sa || q * c / z * r == this.i))) {
				if (Sa = this.context)
					ma = l.Yd(p, c, f), Ja = Math.round((x.la - x.fa + 1) * ma[0] / r), ma = Math.round((x.ka -
		...
		bj.prototype.Qf = function (a, b, c, d, e, f, g, h, l) {
			if (c = a.Y(this.a)) {
				var m = w(this),
				n = l ? fj(a, m, b.time) : 1;
				1 !== n || this.a.ia().cg(b.viewState.projection) || this.context.clearRect(d, e, f, g);
		...
		(function (a) {
			...
			function x(a, b, c, d, e) {
				for (var f = [b, c], g; f.length; )
					c = f.pop(), b = f.pop(), c - b <= d || (g = b + Math.ceil((c - b) / d / 2) * d, C(a, g, b, c, e), f.push(b,
							g, g, c))
			}
			var C = b;
			e.prototype = {
				...
				search: function (a) {
					...
					for (var e = [], f, g, h, l; b; ) {
						...
						for (g = b.children.length; f < g; f++)
							h = b.children[f], l = b.cb ? d(h) : h, r(a, l) && (b.cb ? c.push(h) : q(a, l) ? this.qh(h, c) : e.push(h));
						b = e.pop()
					}
					return c
				},
				Jk: function (a) {
					...
					for (var d = [], e, f, g, h; b; ) {
						...
						for (f = b.children.length; e < f; e++)
							if (g = b.children[e], h = b.cb ? c(g) : g, r(a, h)) {
								if (b.cb || q(a, h))
									return !0;
								d.push(g)
							}
				...
				load: function (a) {
					...
					this.data.children.length ? this.data.height === a.height ? this.xh(this.data, a) : (this.data.height < a.height && (b = this.data, this.data = a, a = b), this.uh(a, this.data.height - a.height - 1, !0)) : this.data = a;
					return this
				},
				Ca: function (a) {
				...
				remove: function (a,
					...
					for (var c = this.data, d = this.wb(a), e = [], f = [], g, h, l, m; c || e.length; ) {
						...
						m || c.cb || !q(c, d) ? h ? (g++, c = h.children[g], m = !1) : c = null : (e.push(c), f.push(g), g = 0, h = c, c = c.children[0])
					}
					return this
				},
				wb: function (a) {
				...
				qh: function (a,
					b) {
					for (var c = []; a; )
						a.cb ? b.push.apply(b, a.children) : c.push.apply(c, a.children), a = c.pop();
					return b
				},
				sh: function (a, b, c, d) {
					var e = c - b + 1,
				...
				sk: function (a, b, c, d) {
					for (var e, f, g, h, l, m, p, q; ; ) {
						d.push(b);
						if (b.cb || d.length - 1 === c)
							break;
						p = q = Infinity;
						e = 0;
						for (f = b.children.length; e < f; e++)
							g = b.children[e], l = n(g), m = (Math.max(g.la, a.la) - Math.min(g.fa, a.fa)) * (Math.max(g.ka, a.ka) - Math.min(g.ea, a.ea)) - l, m < q ? (q = m, p = l < p ? l : p, h = g) : m === q && l < p && (p = l, h = g);
						b = h || b.children[0]
					}
					return b
				},
				uh: function (a, b, c) {
					...
					e.children.push(a);
					for (h(e, c); 0 <= b; )
						if (d[b].children.length > this.Jf)
							this.yk(d, b),
							b--;
						else
							break;
				...
				rh: function (a, b, c, d) {
					...
					for (m = c - b - 1; m >= b; m--)
						n = a.children[m], h(f, a.cb ? d(n) : n), l += p(f);
					return l
				},
				pk: function (a, b, c) {
					for (; 0 <= c; c--)
				...
				tk: function (a) {
					for (var b = a.length - 1, c; 0 <= b; b--)
						0 === a[b].children.length ? 0 < b ? (c = a[b - 1].children, c.splice(c.indexOf(a[b]), 1)) : this.clear() : f(a[b], this.wb)
				},
				vk: function (a) {
					var b = ["return a", " - b", ";"];
		...
		function kj(a, b, c, d, e, f, g, h, l, m, n, p, q, r, u, x) {
			...
			if (h) {
				if (q || 1 != h[4])
					Ta(h, a), h.push(q ? [b, x ? x.slice(0) : null, m, e, n, p, u, l, c, d, r] : null)
			} else
				q && ii(b, x, m, e, n, p, u,
					l, c, d, r)
		}
		...
		k.Eh = function (a, b, c) {
			...
			if ("MultiPolygon" == d) {
				d = yi(a);
				var h = [];
				for (var l = a.rd(), m = g = 0, n = l.length; m < n; ++m) {
					var p = [];
					g = oj(this, d, g, l[m], e, p);
					h.push(p)
				}
				this.a.push([4, f, h, a, c, Bf])
			} else
				"Polygon" == d || "MultiLineString" == d ? (h = [], d = "Polygon" == d ? a.Xb() : a.da(), oj(this, d, 0, a.ob(), e, h), this.a.push([4, f, h, a, c, Af])) : "LineString" == d || "MultiPoint" == d ? (d = a.da(), e = mj(this, d, 0, d.length, e, !1, !1), this.a.push([4, f, e, a, c, zf])) : "Point" == d && (d = a.da(), this.coordinates.push(d[0],
		...
		function rj(a, b) {
			if (b && 5 < b.length) {
				...
				if (1 == c || c == b.length - 5) {
					...
					if (!a.ca.Jk(c))
						for (a.ca.Ca(c), a = 5, c = b.length; a < c; ++a)
							b[a] && ii.apply(void 0, b[a]);
					b.length = 5;
					Na(b)
				}
			}
		...
		function sj(a, b, c, d, e, f, g, h) {
			if (a.oa && gc(c, a.aa))
				...
				a.oa || (a.oa = []), l = Se(a.coordinates, 0, a.coordinates.length, 2, c, a.oa), Ze(a.aa, c);
			for (var m = !mb(e), n = 0, p = f.length, q, r, u, x, C, z, E, V, ya, fa = 0, pa = 0, Ja = a.mb, ma = {
					context: b,
					pixelRatio: a.pixelRatio,
					resolution: a.resolution,
					rotation: d
				}, Sa = a.a != f || a.overlaps ? 0 : 200; n < p; ) {
				var N = f[n];
				switch (N[0]) {
				case 0:
					var hc = N[1];
				...
				case 6:
					...
					ju = N[14],
					ku = N[15];
					for (N[11] && (ap += d); q < r; q += 2)
						kj(a, b, l[q], l[q + 1], Kg, u, x, ya, Eh, Gk, rf, hu, ap, iu, ju, ku);
					rj(a, ya);
					++n;
					break;
				case 5:
					...
					if (lu || jp <= ip) {
						a: {
							...
							for (var Lg = sf[ue], Mg = sf[ue + 1], Jk =
								...
								var Ng = qu(Vf) - Kk;
								Kk += Ng;
								for (var op = mp + Ng / 2; ue < kp - 2 && Jk + Ki < op; )
									Gh = Lg, Hh = Mg, ue += 2, Lg = sf[ue], Mg = sf[ue + 1], Jk += Ki, Ki = Math.sqrt(Math.pow(Lg - Gh, 2) + Math.pow(Mg - Hh, 2));
								var tu = op - Jk,
								Og = Math.atan2(Mg - Hh, Lg - Gh);
								Fh && (Og += 0 < Og ? -Math.PI : Math.PI);
								if (void 0 !== Ji) {
									var Mi = Og - Ji;
									Mi += Mi > Math.PI ? -2 * Math.PI : Mi < -Math.PI ? 2 * Math.PI : 0;
									if (Math.abs(Mi) > ru) {
										var Pg = null;
										break a
									}
						...
						if (Pg) {
							...
							if (mu)
								for (Wf = 0, Ni = Pg.length; Wf < Ni; ++Wf)
									ce = Pg[Wf], Mk = ce[4], Me = a.Y(Mk, !0, !1), u = ce[2], x = Hk * Me.height - ep, kj(a, b, ce[0],
				...
				case 9:
					...
					V = Jh + .5 | 0;
					if (E !== C || V !== z)
						b.moveTo(Ih, Jh), C = E, z = V;
					for (q += 2; q < r; q += 2)
						if (Ih = l[q], Jh = l[q + 1], E = Ih + .5 | 0, V = Jh + .5 | 0, q == r - 2 || E !== C || V !== z)
							b.lineTo(Ih, Jh), C = E, z = V;
					++n;
					break;
				case 10:
					a.W = N[2];
		...
		k.Ma = function (a, b, c, d) {
			sj(this, a, b, c, d, this.a, void 0, void 0)
		};
		function tj(a) {
			var b = a.b;
			b.reverse();
		...
		function Aj(a, b) {
			var c = a.state,
			d = c.fillStyle;
			if (void 0 !== d && ("string" !== typeof d || c.Kk != d)) {
				var e = [10, d];
				"string" !== typeof d && (b = b.C(), e.push([b[0], b[3]]));
				a.a.push(e);
				c.Kk = c.fillStyle
			}
		...
		var Ej = function () {
			...
			return function (c) {
				var d = b[c];
				void 0 == d && (a || (a = document.createElement("span"), a.textContent = "M", a.style.margin = a.style.padding = "0 !important", a.style.position = "absolute !important", a.style.left = "-99999px !important"), a.style.font = c, document.body.appendChild(a), d = b[c] = a.offsetHeight, document.body.removeChild(a));
				return d
			}
		}
		(),
			...
			if ("" !== this.sa && e && (c || d)) {
				...
				if ("line" === e.placement) {
					...
					for (f = l.length; m < f; ++m) {
						if (void 0 == a) {
							for (var q,
								r, u = void 0, x = void 0, C = g = r = q = void 0, z = p = n, E = 0, V = 0, ya = n; n < l[m]; n += h) {
								var fa = d[n],
								pa = d[n + 1];
					...
					case "Polygon":
						d = a.Sd();
						if (!e.exceedLength && d[2] / this.resolution < m)
							return;
						h = 3;
						break;
					case "MultiPolygon":
						...
						d = [];
						g = 0;
						for (a = f.length; g < a; g += 3)
							(e.exceedLength || f[g + 2] / this.resolution >= m) && d.push(f[g], f[g + 1]);
						g = d.length;
						if (0 == g)
							return
					}
		...
		Dj.prototype.Y = function (a, b, c) {
			...
			if (!di.a.hasOwnProperty(d)) {
				...
				if (c)
					for (c = 0; c < n; ++c)
						r.strokeText(a[c], h + e * p[c], .5 * m + c * q);
				if (b)
					for (c = 0; c < n; ++c)
						r.fillText(a[c], h + e * p[c], .5 * m + c * q)
			}
			return di.get(d)
		};
		function Gj(a, b, c, d) {
			...
			r = l.font,
			u = l.scale;
			f = f ? f.lineWidth * u / 2 : 0;
			var x = a.H;
			a.a.push([5, b, c, m, d, l.exceedLength, g, l.maxAngle, function (a) {
						var b = x[a];
						b || (b = x[a] = Fj(r, a));
						return b * u * e
					}, n, h, f * e, q, p, 1]);
			a.b.push([5, b, c, m, d, l.exceedLength, g, l.maxAngle, function (a) {
						var b = x[a];
						b || (b = x[a] = Fj(r, a));
						return b * u
					}, n, h, f, q, p, 1 / e])
		...
		function Kj(a) {
			...
			b = a;
			for (var e = d = 0; b >= d; )
				Jj(c, a + b, a + d), Jj(c, a + d, a + b), Jj(c, a - d, a + b), Jj(c, a - b, a + d), Jj(c, a - b, a - d), Jj(c, a - d, a - b), Jj(c, a + d, a - b), Jj(c, a + b, a - d), d++, e += 1 + 2 * d, 0 < 2 * (e - b) + 1 && (--b, e += 1 - 2 * b);
			return Ij[a] = c
		}
		function Lj(a, b, c, d, e) {
			for (var f = Object.keys(a).map(Number).sort(bc), g = 0, h = f.length; g < h; ++g)
				for (var l = a[f[g].toString()], m = l.length - 1; 0 <= m; ) {
					var n = l[m--],
					p = l[m--];
					if (n = sj(p, b, n, c, {}, p.b, d, e))
						return n
				}
		}
		k = Hj.prototype;
		k.Vb = function (a) {
			var b = null;
			this.g && (a ? (b = this.a, b[4]++) : (b = this.a = Ca(), b.push(1)));
			return b
		};
		function Mj(a) {
			for (var b in a.b) {
		...
		k.Ja = function (a, b) {
			...
			c = a[b];
			void 0 === c && (c = new Pj[b](this.o, this.c, this.v, this.s, this.l, this.g), a[b] = c);
			return c
		};
		k.wg = function () {
			return mb(this.b)
		};
		k.Ma = function (a, b, c, d, e, f) {
		...
		function Nj(a, b, c, d, e, f, g, h) {
			...
			for (m = l.length - 1; 0 <= m; --m) {
				var p = l[m].toString();
				var q = a.b[p];
				for (n = Bj.length - 1; 0 <= n; --n) {
					var r = Bj[n];
					var u = q[r];
					if (void 0 !== u)
						if (!h || "Image" != r && "Text" != r) {
							if (u = sj(u, b, c, d, e, u.b, f, g))
								return u
		...
		function Sj(a, b, c, d, e, f) {
			...
			if (h = c.Y()) {
				var l = h.ef();
				2 == l || 3 == l ? h.Tj(e, f) : (0 == l && h.load(), h.di(e, f), g = !0)
			}
			if (e = (0, c.ab)(b))
				if (d = e.Vd(d), c.He())
					Tj(a, d, c, b);
		...
		var Uj = {
			Point: function (a, b, c, d) {
				...
				if (f = c.Ka())
					c = a.Ja(c.Ba(), "Text"), c.kb(f, a.Vb(!!e)), c.Wb(b, d)
			},
			LineString: function (a, b, c, d) {
				...
				if (e = c.Ka())
					c = a.Ja(c.Ba(), "Text"), c.kb(e, a.Vb(!1)), c.Wb(b, d)
			},
			Polygon: function (a, b, c, d) {
				...
				if (e = c.Ka())
					c = a.Ja(c.Ba(), "Text"), c.kb(e, a.Vb(!1)),
					c.Wb(b, d)
			},
		...
		v(Vj, Ii);
		Vj.handles = function (a, b) {
			return "canvas" === a && "VECTOR" === b.T()
		};
		Vj.create = function (a, b) {
			return new Vj(b)
		};
		k = Vj.prototype;
		k.ha = function () {
			Mc(di, "clear", this.Si, this);
		...
		k.xg = function (a, b, c) {
			...
			if (r && !r.wg()) {
				...
				if (x || C) {
					...
					if (l) {
						var V = Math.round(Math.sqrt(z * z + E * E));
						q = (V - z) / 2;
						u = (V - E) / 2;
						z = E = V
					}
				...
				if (n.D && h.g && !Ka(m, d)) {
					...
					n = ab(m);
					for (var ya = 0; h < m[0]; )
						--ya, p = n * ya, p = Qi(this, a, p), r.Ma(z, p, l, f), h += n;
					ya = 0;
					for (h = d[2]; h > m[2]; )
						++ya, p = n * ya, p = Qi(this, a, p), r.Ma(z, p, l, f), h -= n;
					p = Qi(this, a, 0)
		...
		k.Ga = function (a, b, c, d, e) {
			if (this.c) {
				var f = this.a,
				g = {};
				a = this.c.Ga(a, b.viewState.resolution, b.viewState.rotation, c, {}, function (a) {
						var b = w(a).toString();
						if (!(b in g))
		...
		k.Cd = function (a) {
			...
			if (!this.f && this.o == l && this.P == d && this.s == e && Ka(this.l, f))
				return !0;
			this.c = null;
			this.f = !1;
					...
					if (d) {
						...
						if (Array.isArray(d))
							for (var e = 0, f = d.length; e < f; ++e)
								c = Sj(p, a, d[e], Rj(l, m), this.Ti, this) || c;
						else
							c = Sj(p, a, d, Rj(l, m), this.Ti, this);
						a = c
					} else
						a = !1;
					this.f = this.f || a
		...
		v(Xj, bj);
		Xj.handles = function (a, b) {
			return "canvas" === a && "VECTOR_TILE" === b.T()
		};
		Xj.create = function (a, b) {
			return new Xj(b)
		};
		var Yj = {
		...
		k.Cd = function (a, b) {
			...
			this.H = d;
			return bj.prototype.Cd.apply(this, arguments)
		};
		k.Qf = function (a, b, c, d, e, f, g, h, l) {
				...
				for (var ya = 0, fa = m.a.length; ya < fa; ++ya) {
					...
					if (3 != pa.getState()) {
						...
						for (var kc, pf = 0,
							...
							if (kc = jc[pf], hc && ("tile-pixels" == N.a && (N.Nj(Ja), N.Pi(pa.C())), kc.V().jb(N, q)), !Sa || fb(Sa, kc.C())) {
								var Qd = void 0,
								se = kc.fb();
								se ? Qd = se.call(kc, V) : (se = n.fb()) && (Qd = se(kc, V));
								if (Qd) {
									se = ib;
									var of = ma;
									if (Qd) {
										var Kg = !1;
										if (Array.isArray(Qd))
											for (var Eh = 0, Gk = Qd.length; Eh < Gk; ++Eh)
												Kg = Sj(of, kc, Qd[Eh], se, this.Vi, this) || Kg;
										else
											Kg = Sj(of, kc, Qd, se, this.Vi, this);
										kc = Kg
									} else
										kc = !1;
									this.D = this.D || kc;
			...
			if (this.context) {
				...
				r = n.g;
				if ((p = Yj[n.o]) && q.eh !== r)
					for (q.eh = r, C = m.l, V = C[0], q = x.pixelRatio, rf = n.ia(), z = rf.bb(x.viewState.projection), r = z.Sa(V), u = bk(m, n), x = rf.Yd(V, q, x.viewState.projection), u.canvas.width = x[0], u.canvas.height = x[1], x = z.La(C), C = 0, z = m.a.length; C < z; ++C)
						V = m.c[m.a[C]], 3 != V.getState() && (rf = q / r, E = We(this.ca), bf(E, rf, -rf), cf(E, -x[0], -x[3]), ck(V, n, m.xa.toString()).Ma(u, E, 0, {}, p));
		...
		k.Ga = function (a, b, c, d, e) {
			...
			for (p = n.length; q < p; ++q) {
				...
				if (Ha(x, a)) {
					u = 0;
					for (var C = r.a.length; u < C; ++u) {
						var z = r.c[r.a[u]];
						if (3 != z.getState()) {
							z = ck(z, h, r.xa.toString());
							var E = E || z.Ga(a, f, g, c, {}, function (a) {
									var b = w(a).toString();
									if (!(b in m))
										return m[b] = !0, d.call(e, a, h)
								}, l)
						}
					}
				}
		...
		k.mf = function (a, b, c) {
					...
					for (var u = r.xa, x = f.La(u)[0] - f.La(r.l)[0], C = void 0, z = 0, E = r.a.length; z < E; ++z) {
						...
						if (3 != V.getState()) {
							...
							if (fa) {
								...
								pa = 0;
								for (Ja = n.length; pa < Ja; ++pa)
									ma = n[pa], V < p[pa] && (a.beginPath(), a.moveTo(fa[0], fa[1]), a.lineTo(fa[2], fa[3]), a.lineTo(fa[4], fa[5]), a.lineTo(fa[6], fa[7]), a.moveTo(ma[6], ma[7]), a.lineTo(ma[4], ma[5]), a.lineTo(ma[2], ma[3]), a.lineTo(ma[0], ma[1]), a.clip());
								ya.Ma(a, C, m, {}, h, e);
								a.restore();
								n.push(fa);
								p.push(V)
			...
			if (e) {
				...
				for (l =
						g.length; h < l; ++h)
					for (f = e[g[h].toString()], n = 0, p = f.length; n < p; )
						q = f[n++], r = f[n++], q.Ma(d, r, m, {});
				this.l.clear()
			}
		...
		k.up = function (a) {
			if (null !== a.alpha) {
				var b = ua(a.alpha);
				this.set(fk, b);
				"boolean" === typeof a.absolute && a.absolute ? this.set(gk, b) : "number" === typeof a.webkitCompassHeading && -1 != a.webkitCompassAccuracy && this.set(gk, ua(a.webkitCompassHeading))
			}
		...
		k.clone = function () {
			var a = new kk({
					fill: this.Ea() ? this.Ea().clone() : void 0,
					points: this.l,
					radius: this.b,
					radius2: this.g,
					angle: this.j,
					snapToPixel: this.v,
					stroke: this.Fa() ? this.Fa().clone() : void 0,
					rotation: this.f,
		...
		function lk(a, b) {
			...
			if (void 0 === b) {
				...
				b = m = a.o.width;
				a.Gh(c, n, 0, 0);
				a.Ya ? a.D = a.o : (n = gg(c.size, c.size), a.D = n.canvas, a.Fh(c, n, 0, 0))
			} else
				m =
		...
		k.Ua = function (a) {
			"function" === typeof a ? this.ab = a : "string" === typeof a ? this.ab = function (b) {
				return b.get(a)
			}
			 : a ? void 0 !== a && (this.ab = function () {
				return a
			}) : this.ab = qk;
			this.Tc = a
		};
		...
		k.Jc = function (a) {
			Mc(this, Xc(this.a), this.Ne, this);
			this.a = a;
			y(this, Xc(this.a), this.Ne, this);
			this.Ne()
		};
		...
		function yk(a, b, c, d, e, f) {
			...
			if (1 === l)
				...
				m = g.length;
				for (n = !1; l < m; )
					e = l + (m - l >> 1), h = +bc(g[e], c), 0 > h ? l = e + 1 : (m = e, n = !h);
				e = n ? l : ~l;
		...
		function Ak(a, b, c, d, e, f) {
			var g = 0;
			if (f)
				return zk(a, g, b[b.length - 1], c, d, e);
			if (d < a[c - 1])
		...
		k = I.prototype;
		k.Ak = function (a) {
			this.A ? ec(this.A, a) : this.A = a.slice();
			this.u()
		};
		k.clone = function () {
			var a = new I(null);
		...
		k.Nb = function (a, b, c, d) {
			if (d < Ga(this.C(), a, b))
				return d;
			this.o != this.g && (this.D = Math.sqrt(qf(this.A, 0, this.A.length, this.a, 0)), this.o = this.g);
			return uf(this.A, 0, this.A.length, this.a, this.D, !1, a, b, c, d)
		};
		k.Zk = function (a, b) {
			return Kf(this.A, 0, this.A.length, this.a, a, b)
		};
		k.Kn = function (a, b) {
			return "XYM" != this.ja && "XYZM" != this.ja ? null : zk(this.A, 0, this.A.length, this.a, a, void 0 !== b ? b : !1)
		};
		k.U = function () {
			return zf(this.A, 0, this.A.length, this.a)
		};
		k.Mh = function (a, b) {
			return yk(this.A, 0, this.A.length, this.a, a, b)
		};
		k.Ln = function () {
			return ij(this.A, 0, this.A.length, this.a)
		};
		k.Ee = function () {
			this.j != this.g && (this.c = this.Mh(.5, this.c), this.j = this.g);
			return this.c
		};
		k.vd = function (a) {
			var b = [];
		...
		k.$a = function (a) {
			return Lf(this.A, 0, this.A.length, this.a, a)
		};
		k.na = function (a, b) {
			a ? (kf(this, b, a, 1), this.A || (this.A = []), this.A.length = xf(this.A, 0, a, this.a), this.u()) : this.ba("XY", null)
		};
		k.ba = function (a, b) {
			jf(this, a, b);
			this.u()
		...
		function Bk(a, b, c) {
			for (var d = [], e = a(0), f = a(1), g = b(e), h = b(f), l = [f, e], m = [h, g], n = [1, 0], p = {}, q = 1E5, r, u, x, C, z; 0 < --q && 0 < n.length; )
				x = n.pop(), e = l.pop(), g = m.pop(), f = x.toString(), f in p || (d.push(g[0], g[1]), p[f] = !0), C = n.pop(), f = l.pop(), h = m.pop(), z = (x + C) / 2, r = a(z), u = b(r), sa(u[0], u[1], g[0], g[1], h[0], h[1]) < c ? (d.push(h[0], h[1]), f = C.toString(), p[f] = !0) : (n.push(C, z, z, x), m.push(h, u, u, g), l.push(f, r, r, e));
			return d
		}
		function Ck(a, b, c, d, e) {
			var f = Nb("EPSG:4326");
			return Bk(function (d) {
				return [a, b + (c - b) * d]
			}, Xb(f, d), e)
		}
		...
		function Ek(a) {
			...
			this.Ya = void 0 !== a.fill ? a.fill : new nk({
					color: "#333"
				});
		...
		function Fk(a) {
			...
			1 == a.showLabels && (this.aa = void 0 == a.lonLabelFormatter ? Ce.bind(this, "EW") : a.lonLabelFormatter, this.Va = void 0 == a.latLabelFormatter ? Ce.bind(this, "NS") : a.latLabelFormatter,
				this.ca = void 0 == a.lonLabelPosition ? 0 : a.lonLabelPosition, this.W = void 0 == a.latLabelPosition ? 1 : a.latLabelPosition, this.H = void 0 !== a.lonLabelStyle ? a.lonLabelStyle : new Ek({
					...
					}), this.B = void 0 !== a.latLabelStyle ? a.latLabelStyle : new Ek({
						font: "12px Calibri,sans-serif",
						textAlign: "end",
						fill: new nk({
							color: "rgba(0,0,0,1)"
		...
		function Pk(a, b, c, d, e, f, g) {
			...
			h.ba("XY", c);
			fb(h.C(), f) && (a.b && (c = g, d = h.da(), f = [d[0], oa(f[1] + Math.abs(f[1] - f[3]) * a.ca, Math.max(f[1], d[1]), Math.min(f[3], d[d.length - 1]))], c = void 0 !== a.b[c] ? a.b[c].Pd : new B(null), c.na(f), a.b[g] = {
						Pd: c,
						text: a.aa(b)
					}), a.g[g++] = h);
			return g
		...
		function Qk(a, b, c, d, e, f, g) {
			...
			h.ba("XY", c);
			fb(h.C(), f) && (a.a && (c = g, d = h.da(), f = [oa(f[0] + Math.abs(f[0] - f[2]) * a.W, Math.max(f[0], d[0]), Math.min(f[2], d[d.length - 2])), d[1]], c = void 0 !== a.a[c] ? a.a[c].Pd : new B(null), c.na(f), a.a[g] = {
						Pd: c,
						text: a.Va(b)
					}), a.c[g++] = h);
			return g
		...
		k.ai = function (a) {
			...
			if (-1 == d)
				...
				for (l = 0; u != this.s &&
					l++ < g; )
					u = Math.max(u - d, this.s), n = Pk(this, u, q, p, c, a, n);
				u = oa(e, this.s, this.j);
				for (l = 0; u != this.j && l++ < g; )
					u = Math.min(u + d, this.j), n = Pk(this, u, q, p, c, a, n);
				this.g.length = n;
				...
				for (l = 0; e != this.l && l++ < g; )
					e = Math.max(e - d, this.l), n = Qk(this, e, r, h, c, a, n);
				e = oa(f, this.l, this.f);
				for (l = 0; e != this.f && l++ < g; )
					e = Math.min(e + d, this.f), n = Qk(this, e, r, h, c, a, n);
				this.c.length = n;
			...
			if (this.b)
				for (a = 0, c = this.b.length; a < c; ++a)
					e = this.b[a], this.H.Gd(e.text), b.kb(this.H), b.Hb(e.Pd);
			if (this.a)
				for (a = 0, c = this.a.length; a < c; ++a)
					e = this.a[a], this.B.Gd(e.text), b.kb(this.B), b.Hb(e.Pd)
		};
		k.setMap = function (a) {
		...
		v(Rk, Sc);
		Rk.prototype.u = function () {
			this.b("change")
		};
		Rk.prototype.C = function () {
			return this.extent
		};
		Rk.prototype.getState = function () {
			return this.state
		};
		function Sk(a, b, c, d, e, f) {
			Rk.call(this, a, b, c, 0);
			this.i = d;
			this.N = new Image;
		...
		k.bn = function () {
			void 0 === this.resolution && (this.resolution = bb(this.extent) / this.N.height);
			this.state = 2;
			this.g.forEach(Gc);
			this.g = null;
			this.u()
		...
		k.load = function () {
			if (0 == this.state || 3 == this.state)
				this.state = 1, this.u(), this.g = [Lc(this.N, "error", this.an, this), Lc(this.N, "load", this.bn, this)], this.c(this, this.i)
		};
		k.hh = function (a) {
			this.N = a
		};
		...
		Tk.prototype.getState = function () {
			return this.state
		};
		function dj(a, b) {
			a.state = b;
		...
		k = Vk.prototype;
		k.ha = function () {
			1 == this.state && (Wk(this), this.N = Xk());
			this.g && Pc(this.g);
			this.state = 5;
			this.u();
		...
		k.load = function () {
			if (0 == this.state || 3 == this.state)
				this.state = 1, this.u(), this.c = [Lc(this.N, "error", this.Zm, this), Lc(this.N, "load", this.$m, this)], this.l(this, this.f)
		};
		function Wk(a) {
			a.c.forEach(Gc);
			a.c = null
		...
		fl.prototype.Ma = function (a, b, c, d, e, f, g, h, l, m, n) {
			...
			if (void 0 === l)
				...
				m ? a = this.De(p, a, h, l, n) : (p.clear(p.COLOR_BUFFER_BIT | p.DEPTH_BUFFER_BIT), this.Nd(p, a, h, !0), a = (a = l(null)) ? a : void 0);
				var fa = a
			}
			this.Af(p, f);
		...
		k.cc = function (a, b) {
			...
			if (c) {
				...
				f;
				for (f = 0; 2 > f; f += d)
					this.a[b++] = a[f], this.a[b++] = a[f + 1], this.a[b++] = 0, this.a[b++] = this.P, this.a[b++] = a[f], this.a[b++] = a[f + 1], this.a[b++] = 1, this.a[b++] = this.P, this.a[b++] = a[f], this.a[b++] = a[f + 1], this.a[b++] = 2, this.a[b++] = this.P, this.a[b++] = a[f], this.a[b++] =
		...
		k.De = function (a, b, c, d, e) {
			...
			for (f = this.o.length - 1; 0 <= f; --f) {
				...
				for (g = this.o[f]; 0 <= h && this.g[h] >= g; ) {
					...
					var n = this.i[h];
					var p = w(n).toString();
					if (void 0 === c[p] && n.V() && (void 0 === e || fb(e, n.V().C())) && (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), hl(a, b, m, l), l = d(n)))
						return l;
					h--;
					l = m
				}
		...
		k.Oa = function (a, b) {
			if (b) {
				...
				c = b.a;
				c instanceof CanvasGradient || c instanceof CanvasPattern ? c = kl : c = li(c).map(function (a, b) {
						return 3 != b ? a / 255 : a
					}) || kl;
				b = b.c;
				b = void 0 !== b ? b : 1
				...
				c = [0, 0, 0, 0], b = 0;
			a = a ? a.b : [0, 0, 0, 0];
			a instanceof CanvasGradient || a instanceof CanvasPattern ? a = il : a = li(a).map(function (a, b) {
					return 3 != b ? a / 255 : a
				}) || il;
			this.c.strokeColor && gc(this.c.strokeColor, c) && this.c.fillColor && gc(this.c.fillColor, a) && this.c.lineWidth === b || (this.c.u =
		...
		k.De = function (a, b, c, d, e) {
			...
			for (f = l.length - 1; 0 <= f; --f) {
				...
				for (g = this.o[f]; 0 <= h && this.g[h] >= m; ) {
					...
					var p = this.i[h];
					var q = w(p).toString();
					if (void 0 === c[q] && p.V() && (void 0 === e || fb(e, p.V().C())) && (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), hl(a, b, n, g), g = d(p)))
						return g;
					g = n;
					h--
				}
		...
		k.eb = function () {
			this.qa = this.oa = this.height = this.B = this.D = void 0;
			this.b = null;
		...
		k.gg = function (a) {
			return a ? this.H.concat(this.P) : this.H
		};
		k.Zf = function () {
			return this.P
		};
		function Hl(a, b, c) {
			var d = b - c;
			return a[0] === a[d] && a[1] === a[d + 1] && 3 < (b - 0) / c ? !!lf(a, 0, b, c) : !1
		};
		...
		function Ml(a, b, c, d) {
			...
			for (e = 0; e < c; e += d) {
				...
				if (0 === e) {
					...
					m ? x = C : (r = r || [0, 0], f = Nl(a, r, u, [0, 0], p * Ql * (l || 1), f), f = Nl(a, r, u, [0, 0], -p * Ql * (l || 1), f), a.b[g++] = q, a.b[g++] = n - 1, a.b[g++] = n, a.b[g++] = n, a.b[g++] = q + 1, a.b[g++] = q, l && (f = Nl(a, r, u, [0, 0], p * Rl * l, f), f = Nl(a, r, u, [0, 0], -p * Rl * l, f), a.b[g++] = q + 2, a.b[g++] = q, a.b[g++] = q + 1, a.b[g++] = q + 1, a.b[g++] = q + 3, a.b[g++] = q + 2));
					break
				} else
					x = [b[e + d], b[e + d + 1]];
		...
		function Wl(a, b, c, d) {
			c -= b;
			return c < 2 * d ? !1 : c === 2 * d ? !gc([a[b], a[b + 1]], [a[b + d], a[b + d + 1]]) : !0
		}
		k = Ll.prototype;
		k.tc = function (a, b) {
			var c = a.da();
		...
		function Xl(a, b, c, d) {
			Hl(b, b.length, d) || (b.push(b[0]), b.push(b[1]));
			Ml(a, b, b.length, d);
			if (c.length) {
				var e;
				b = 0;
				for (e = c.length; b < e; ++b)
					Hl(c[b], c[b].length, d) || (c[b].push(c[b][0]), c[b].push(c[b][1])), Ml(a, c[b], c[b].length, d)
			}
		}
		function Yl(a, b, c) {
		...
		k.Oa = function (a, b) {
			...
			a = b.a;
			a instanceof CanvasGradient || a instanceof CanvasPattern ? a = kl : a = li(a).map(function (a, b) {
					return 3 != b ? a / 255 : a
				}) || kl;
			var c = b.c;
			c = void 0 !== c ? c : 1;
		...
		cm.prototype.concat = function (a) {
			if (a.b) {
				if (this.b) {
					var b = this.b.next;
					this.b.next = a.g;
		...
		k.C = function (a) {
			var b = this.a.data;
			return Ma(b.fa, b.ea, b.la, b.ka, a)
		};
		k.concat = function (a) {
			this.a.load(a.a.all());
			for (var b in a.b)
		...
		function rm(a, b, c, d) {
			...
			if (c.length) {
				...
				h.sort(function (a, b) {
					return b.Cc[0] === a.Cc[0] ? a.Cc[1] - b.Cc[1] : b.Cc[0] - a.Cc[0]
				});
				for (l = 0; l < h.length; ++l) {
					...
					!n && wm(c, h[l].Cc[0], e, b[0], f) && (f.concat(h[l].fh), um(e, f, !1))
				}
			} else
				um(e, f, !1);
			xm(a,
		...
		function sm(a, b, c, d, e, f) {
			...
			l = [],
			m = [];
			if (f === Nf(b, 0, b.length, c)) {
				var n = f = ym(a, b[0], b[1], h++);
				var p = c;
				for (g = b.length; p < g; p += c) {
					var q = ym(a, b[p], b[p + 1], h++);
					m.push(zm(n, q, d));
					l.push([Math.min(n.x, q.x), Math.min(n.y, q.y), Math.max(n.x, q.x), Math.max(n.y, q.y)]);
					n = q
				}
			} else
				for (p = b.length - c, n = f = ym(a, b[p], b[p + 1], h++), p -= c, g = 0; p >= g; p -= c)
					q = ym(a, b[p], b[p + 1], h++), m.push(zm(n, q, d)), l.push([Math.min(n.x, q.x), Math.min(n.y, q.y), Math.max(n.x, q.x), Math.max(n.y, q.y)]), n = q;
			m.push(zm(q, f, d));
		...
		function tm(a) {
			...
			d = [c.Z.x, c.Z.y];
			do
				c = fm(a), c.Z.x > d[0] && (d = [c.Z.x, c.Z.y]);
			while (c !== b);
			return d
		}
		function um(a, b, c) {
			...
			g = !1;
			do {
				var h = c ? ll(f.X.x, f.X.y, e.X.x, e.X.y, e.Z.x, e.Z.y) : ll(e.Z.x, e.Z.y, e.X.x, e.X.y, f.X.x, f.X.y);
		...
		function wm(a, b, c, d, e) {
			...
			for (h = l.length; m < h; ++m) {
				...
				p = Bm(b, d, n.Z, n.X, !0),
				q = Math.abs(b.x - p[0]);
				if (q < g && void 0 !== ll(b.x, b.y, n.Z.x, n.Z.y, n.X.x, n.X.y)) {
					g = q;
					var r = {
						x: p[0],
						y: p[1],
		...
		function xm(a, b, c) {
			for (var d = !1, e = Dm(b, c); 3 < b.c; )
				if (e) {
					if (!Em(a, b, c, e, d) && !um(b, c, d) && !Fm(a, b, c, !0))
						break
				} else if (!Em(a, b, c, e, d) && !um(b, c, d) && !Fm(a, b, c))
					if (e = Dm(b, c)) {
						d = b;
						var f = 2 * d.c,
						g = Array(f),
						...
						do {
							...
							if (h.length) {
								...
								lm(c, [Math.min(f.Z.x, h.x), Math.min(f.Z.y, h.y), Math.max(f.Z.x, h.x), Math.max(f.Z.y,
											h.y)], f);
								for (f = fm(d); f !== g; )
									zm(f.Z, f.X, l, m), c.remove(f), dm(d), f = jm(d);
								zm(g.Z, h, l, m);
								g.Z = h;
		...
		function Em(a, b, c, d, e) {
			...
			do {
				...
				var u = m.X;
				if (!1 === r.Kb) {
					var x = d ? 0 === Cm(q, r, u, c, !0).length : e ? Gm(n.X, u, r, q, h.Z) : Gm(h.Z, q, r, u, n.X);
					!d && 0 !== vm({
						Z: q,
						X: u
					}, c).length || !x || !d && !1 !== q.Kb && !1 !== u.Kb && Nf([h.Z.x, h.Z.y, q.x, q.y, r.x, r.y, u.x, u.y, n.X.x, n.X.y], 0, 10, 2) !== !e || (a.b[f++] = q.pb, a.b[f++] = r.pb, a.b[f++] = u.pb, Am(l, m, b, c), m === g && (g = n), p = !0)
				}
				h = im(b);
				l = jm(b);
				m = fm(b);
		...
		function zm(a, b, c, d) {
			...
			if (g) {
				...
				c.g = f, c.a = f, c.i && (f.next = f, f.Eb = f);
			c.b = f;
			c.c++;
		...
		function Cm(a, b, c, d, e) {
			...
			for (f = l.length; d < f; ++d)
				for (g in l[d]) {
					var m = l[d][g];
					"object" !== typeof m || e && !m.Kb || m.x === a.x && m.y === a.y || m.x === b.x && m.y === b.y || m.x === c.x && m.y === c.y || -1 !== h.indexOf(m) || !Hf([a.x, a.y, b.x, b.y, c.x, c.y], 0, 6, 2, m.x, m.y) || h.push(m)
				}
			return h
		}
		function vm(a, b, c) {
			var d = a.Z,
			e = a.X;
			b = nm(b, [Math.min(d.x, e.x), Math.min(d.y, e.y), Math.max(d.x, e.x), Math.max(d.y, e.y)]);
			var f = [],
			g;
			var h = 0;
			for (g = b.length; h < g; ++h) {
				var l = b[h];
				a !== l && (c || l.Z !== e || l.X !== d) && Bm(d, e, l.Z, l.X, c) && f.push(l)
			}
			return f
		}
		function Bm(a, b, c, d, e) {
			var f = (d.y - c.y) * (b.x - a.x) - (d.x - c.x) * (b.y - a.y);
			if (0 !== f && (d = ((d.x - c.x) * (a.y - c.y) - (d.y - c.y) * (a.x - c.x)) / f, c = ((b.x - a.x) * (a.y - c.y) - (b.y - a.y) * (a.x - c.x)) / f, !e && d > ml && d < 1 - ml && c > ml && c < 1 - ml || e && 0 <= d && 1 >= d && 0 <= c && 1 >= c))
		...
		k.Oa = function (a, b) {
			...
			b ? this.f.Oa(null, b) : this.f.Oa(null, new ok({
					color: [0, 0, 0, 0],
					lineWidth: 0
				}))
		};
		...
		Jm.prototype.add = function (a, b, c, d, e, f) {
			if (b + this.b > this.g || c + this.b > this.g)
				return null;
			d = Mm(this, !1, a, b, c, d, f);
			if (!d)
				return null;
			a = Mm(this, !0, a, b, c, void 0 !== e ? e : da, f);
			return Lm(d, a)
		};
		function Mm(a, b, c, d, e, f, g) {
			...
			for (l = h.length; m < l; ++m) {
				...
				if (n = n.add(c, d, e, f, g))
					return n;
				n || m !== l - 1 || (b ? (n = Math.min(2 * a.c, a.g), a.c = n) : (n = Math.min(2 * a.a, a.g), a.a = n), n = new Hm(n, a.b), h.push(n), ++l)
			}
			return null
		};
		function Nm(a, b) {
		...
		k.Wb = function (a, b) {
			if (this.sa) {
				...
				g,
				h,
				l = Math.round(f[0] * this.mb - this.aa),
		...
		k.kb = function (a) {
			...
			if (a && a.Ka() && (c || d)) {
				...
				for (d = a.length; e < d; ++e)
					c += a[e];
				e = c;
				this.H[e] || (a = this.Ub.getContext("2d"), a.font = b.font, a = Math.ceil((1.5 * a.measureText("M").width + b.lineWidth / 2) * b.scale), this.H[e] = {
						zh: new Jm({
							space: b.lineWidth + 1
						}),
						width: {},
		...
		k.Ja = function (a, b) {
			...
			c = a[b];
			void 0 === c && (c = new Tm[b](this.i, this.c), a[b] = c);
			return c
		};
		k.wg = function () {
			return mb(this.a)
		...
		k.Ma = function (a, b, c, d, e, f, g, h) {
			...
			for (m = l.length; p < m; ++p) {
				...
				var r = 0;
				for (n = Bj.length; r < n; ++r) {
					var u = q[Bj[r]];
					void 0 !== u && u.Ma(a, b, c, d, e, f, g, h, void 0, !1)
				}
			}
		};
		function Um(a, b, c, d, e, f, g, h, l, m, n) {
			var p = Vm,
		...
		k.Ga = function (a, b, c, d, e, f, g, h, l, m) {
			var n = b.b;
			n.bindFramebuffer(n.FRAMEBUFFER, yl(b));
			var p;
			void 0 !== this.g && (p = Ea(Oa(a), d * this.g));
			return Um(this, b, a, d, e, g, h, l, function (a) {
		...
		function Wm(a, b, c, d, e, f, g, h) {
			var l = c.b;
			l.bindFramebuffer(l.FRAMEBUFFER, yl(c));
			return void 0 !== Um(a, c, b, d, e, f, g, h, function () {
		...
		function fn(a, b, c, d) {
			...
			b = a.C();
			if (!b || Ha(b, e))
				a = Mb(a, c, e) / c, isFinite(a) && 0 < a && (c /= a);
			return c
		}
		function gn(a, b, c, d) {
			a = c - a;
		...
		function hn(a, b, c, d, e, f, g, h, l, m, n) {
			...
			u = c / d;
			l.forEach(function (a) {
				r.drawImage(a.image, m, m, a.image.width - 2 * m, a.image.height - 2 * m, (a.extent[0] - q[0]) * u,  - (a.extent[3] - q[3]) * u, ab(a.extent) * u, bb(a.extent) * u)
			});
			var x = Ya(g);
			h.c.forEach(function (a) {
				...
				m -= b;
				a: {
					g = [[g, h, 0, 0, u - a], [l, m, 0, 0, N - a], [0, 0, g, h, C - n], [0, 0, l, m, hc - n]];
					h = g.length;
					for (l = 0; l < h; l++) {
						m = l;
						for (var ib = Math.abs(g[l][l]), jc = l + 1; jc < h; jc++) {
							var kc = Math.abs(g[jc][l]);
							kc > ib && (ib = kc, m = jc)
						}
						if (0 === ib) {
							g = null;
						...
						g[l] = ib;
						for (m = l + 1; m < h; m++)
							for (ib = -g[m][l] / g[l][l], jc = l; jc < h + 1; jc++)
								g[m][jc] = l == jc ? 0 : g[m][jc] + ib * g[l][jc]
					}
					l = Array(h);
					for (m =
							h - 1; 0 <= m; m--)
						for (l[m] = g[m][h] / g[m][m], ib = m - 1; 0 <= ib; ib--)
							g[ib][h] -= g[ib][m] * l[m];
					g = l
				}
		...
		function kn(a, b, c, d, e, f, g, h, l, m) {
			...
			if (u || !a.f || fb(n, a.f)) {
				...
				if (0 < m && (u || (n = a.a([(b[0] + d[0]) / 2, (b[1] + d[1]) / 2]), q = r ? (va(f[0], q) + va(h[0], q)) / 2 - va(n[0], q) : (f[0] + h[0]) / 2 - n[0], n = (f[1] + h[1]) / 2 - n[1],
							u = q * q + n * n > a.v), u)) {
					Math.abs(b[0] - d[0]) <= Math.abs(b[1] - d[1]) ? (r = [(c[0] + d[0]) / 2, (c[1] + d[1]) / 2], q = a.a(r), n = [(e[0] + b[0]) / 2, (e[1] + b[1]) / 2], p = a.a(n), kn(a, b, c, r, n, f, g, q, p, m - 1), kn(a, n, r, d, e, p, q, h, l, m - 1)) : (r = [(b[0] + c[0]) / 2, (b[1] + c[1]) / 2], q = a.a(r), n = [(d[0] + e[0]) / 2, (d[1] + e[1]) / 2], p = a.a(n), kn(a, b, r, n, e, f, q, p, l, m - 1), kn(a, r, c, d, n, q, g, h, p, m - 1));
					return
				}
				if (r) {
					if (!a.s)
		...
		mn.prototype.ha = function () {
			1 == this.state && (Gc(this.ie), this.ie = null);
			Rk.prototype.ha.call(this)
		};
		mn.prototype.Y = function () {
			return this.i
		};
		mn.prototype.fe = function () {
			var a = this.Tb.getState();
			2 == a && (this.i = hn(ab(this.g) / this.c, bb(this.g) / this.c, this.j, this.Tb.resolution, 0, this.c, this.g, this.f, [{
								extent: this.Tb.C(),
								image: this.Tb.Y()
							}
						], 0));
		...
		mn.prototype.load = function () {
			if (0 == this.state) {
				...
				this.u();
				var a = this.Tb.getState();
				2 == a || 3 == a ? this.fe() : (this.ie = y(this.Tb, "change", function () {
							var a = this.Tb.getState();
							if (2 == a || 3 == a)
								Gc(this.ie), this.ie = null, this.fe()
						}, this), this.Tb.load())
			}
		};
		function nn(a) {
		...
		qn.prototype.Y = function (a, b, c, d) {
			...
			if (e && d && !Wb(e, d)) {
				if (this.i) {
					if (this.va == this.g && Wb(this.i.s, d) && this.i.resolution == b && Ra(this.i.C(), a))
						return this.i;
					Pc(this.i);
					this.i = null
				}
				this.i = new mn(e, d, a, b, c, function (a, b, c) {
						return this.Vc(a, b, c, e)
					}
						.bind(this));
				this.va = this.g;
				return this.i
		...
		v(xn, qn);
		xn.prototype.Vc = function (a, b, c, d) {
			b = rn(this, b);
			var e = this.aa;
			if (e && this.ca == this.g && e.resolution == b && e.a == c && Ka(e.C(), a))
				return e;
			a = a.slice();
			gb(a, this.Xa);
		...
		function yn(a) {
			...
			xn.call(this, {
				attributions: a.attributions,
				canvasFunction: this.Hk.bind(this),
				logo: a.logo,
				projection: a.projection,
				ratio: a.ratio,
				resolutions: a.resolutions,
		...
		k.Hk = function (a, b, c, d, e) {
			...
			this.a.$d(a, b, e);
			var g = !1;
			this.a.dc(a, function (a) {
				var d;
				if (!(d = g)) {
					var e;
					(d = a.fb()) ? e = d.call(a, b) : this.s && (e = this.s(a, b));
					if (e) {
						var h,
						p = !1;
						Array.isArray(e) || (e = [e]);
						...
						for (h = e.length; d < h; ++d)
							p = Sj(f, a, e[d], Rj(b, c), this.Jo, this) || p;
						d = p
					} else
						d = !1
				}
		...
		k.Ga = function (a, b, c, d, e, f) {
			if (this.O) {
				var g = {};
				a = this.O.Ga(a, b, 0, d, e, function (a) {
						var b = w(a).toString();
						if (!(b in g))
							return g[b] = !0, f(a)
					}, null);
		...
		function zn(a, b, c, d, e) {
			c = d / c;
			return df(a.xb, e[0] / 2, e[1] / 2, c, -c, 0, -b[0], -b[1])
		}
		k.Jo = function () {
			this.u()
		};
		k.Ko = function () {
			pn(this, this.a.getState())
		};
		k.Yi = function (a) {
			this.W = void 0 !== a ? a : tk;
		...
		An.prototype.Ga = function (a, b, c, d, e) {
			var f = this.a;
			return f.ia().Ga(a, b.viewState.resolution, b.viewState.rotation, c, b.skippedFeatureUids, function (a) {
				return d.call(e, a, f)
			})
		...
		An.prototype.Ag = function (a, b) {
			...
			p[0] || p[1] || $a(q) || (b = n.Y(q, g, d, e.projection)) && Di(this, b) && (l = b, m = Bn(this, b), this.Mb && a.postRenderFunctions.push(function (a, b) {
					a.isContextLost() || a.deleteTexture(b)
				}
					.bind(null, c, this.Mb)));
			l && (c = this.c.i.j, Cn(this, c.width, c.height, d, f, g, h, l.C()), this.l = null, d = this.v, We(d), bf(d, 1, -1), cf(d, 0,
					-1), this.N = l, this.Mb = m, Fi(a, n));
			return !!l
		};
		...
		An.prototype.bf = function (a, b) {
			return void 0 !== this.Ga(a, b, 0, Qe, this)
		};
		An.prototype.yg = function (a, b, c, d) {
			if (this.N && this.N.Y())
				if (this.a.ia()instanceof yn) {
					var e = $e(b.pixelToCoordinateTransform, a.slice());
					if (this.Ga(e, b, 0, Qe, this))
						return c.call(d, this.a, null)
				} else {
					...
					if (!(0 > a[0] || a[0] > e[0] || 0 > a[1] || a[1] > e[1]) && (this.i ||
							(this.i = gg(1, 1)), this.i.clearRect(0, 0, 1, 1), this.i.drawImage(this.N.Y(), a[0], a[1], 1, 1, 0, 0, 1, 1), e = this.i.getImageData(0, 0, 1, 1).data, 0 < e[3]))
						return c.call(d, this.a, e)
				}
		};
		function Dn(a, b) {
		...
		v(Dn, Vi);
		Dn.handles = function (a) {
			return hd && "webgl" === a
		};
		Dn.create = function (a, b) {
			return new Dn(a, b)
		};
		function En(a, b, c, d) {
			var e = a.g,
			...
			if (a.a.a.hasOwnProperty(f))
				a = a.a.get(f), e.bindTexture(3553, a.Mb), 9729 != a.ei && (e.texParameteri(3553, 10240, 9729), a.ei = 9729), 9729 != a.gi && (e.texParameteri(3553, 10241, 9729), a.gi = 9729);
			else {
		...
		k.ah = function (a) {
			...
			for (g = e.length; h < g; ++h) {
				var l = e[h];
				if (wg(l, f) && "ready" == l.Qj) {
					var m = Yi(this, l.layer);
					m.Ag(a, l, b) && d.push(l)
				}
			}
			...
			for (g = d.length; h < g; ++h)
				l = d[h], m = Yi(this, l.layer), m.Wi(a, l, b);
		...
		k.Ga = function (a, b, c, d, e, f, g) {
			...
			for (m = l.length - 1; 0 <= m; --m) {
				var n = l[m];
				var p = n.layer;
				if (wg(n, h.resolution) && f.call(g, p) && (n = Yi(this, p).Ga(a, b, c, d, e)))
					return n
			}
		};
		k.Ri = function (a, b, c, d, e) {
			...
			for (h = g.length - 1; 0 <= h; --h) {
				var l = g[h],
				m = l.layer;
				if (wg(l, f.resolution) && d.call(e, m) && (c = Yi(this, m).bf(a, b)))
					return !0
			}
			return c
		};
		k.Qi = function (a, b, c, d, e) {
			...
			for (h = g.length - 1; 0 <= h; --h) {
				var l = g[h];
				var m = l.layer;
				if (wg(l, f.resolution) && e.call(d, m) && (l = Yi(this, m).yg(a, b, c, d)))
					return l
			}
		};
		...
		v(Kn, bn);
		Kn.handles = function (a, b) {
			return "webgl" === a && "TILE" === b.T()
		};
		Kn.create = function (a, b) {
			return new Kn(a, b)
		};
		k = Kn.prototype;
		k.ha = function () {
		...
		k.Pf = function (a, b, c) {
			var d = this.c;
			return function (e, f) {
				return Bi(a, b, e, f, function (a) {
					var b = d.a.a.hasOwnProperty(a.ib());
		...
		k.Ag = function (a, b, c) {
			...
			z = a.extent,
			E = tc(m, z, n);
			if (this.l && la(this.l, E) && this.s == l.g)
				u = this.D;
			else {
				...
				for (N = E.fa; N <= E.la; ++N)
					for (hc = E.ea; hc <= E.ka; ++hc) {
						...
						ib = fa.getState();
						if (2 == ib) {
							if (d.a.a.hasOwnProperty(fa.ib())) {
								c[n][fa.xa.toString()] = fa;
								continue
							}
						} else if (4 == ib || 3 == ib && !ma)
							continue;
						ya = !1;
				...
				for (Sa = b.length; ma < Sa; ++ma)
					for (jc in N = c[b[ma]], N)
						fa = N[jc], ib = m.La(fa.xa, pa), Ja[0] = 2 * (ib[2] - ib[0]) / V, Ja[1] = 2 * (ib[3] - ib[1]) / V, Ja[2] = 2 * (ib[0] - u[0]) / V - 1, Ja[3] = 2 * (ib[1] - u[1]) /
			...
			var kc = d.j;
			Hi(a, l, m, r, g, z, n, h.c(), function (a) {
				2 != a.getState() || d.a.a.hasOwnProperty(a.ib()) || a.ib()in kc.a || kc.i([a, yc(m, a.xa), m.Sa(a.xa[0]), q, x * r])
			}, this);
			Ei(a, l);
			Fi(a, l);
			e = this.v;
		...
		v(Ln, bn);
		Ln.handles = function (a, b) {
			return "webgl" === a && "VECTOR" === b.T()
		};
		Ln.create = function (a, b) {
			return new Ln(a, b)
		};
		k = Ln.prototype;
		k.Wi = function (a, b, c) {
		...
		k.Ga = function (a, b, c, d, e) {
			if (this.i && this.l) {
				...
				var f = this.a,
				g = {};
				return this.i.Ga(a, this.c.i, c.center, c.resolution, c.rotation, b.size, b.pixelRatio, this.l.opacity, {}, function (a) {
					var b = w(a).toString();
					if (!(b in g))
						return g[b] = !0, d.call(e, a, f)
				})
		...
		k.bf = function (a, b) {
			if (this.i && this.l) {
				var c = b.viewState;
				return Wm(this.i, a, this.c.i, c.resolution, c.rotation, b.pixelRatio, this.l.opacity, b.skippedFeatureUids)
			}
			return !1
		};
		k.yg = function (a, b, c, d) {
		...
		k.Ag = function (a, b, c) {
					...
					if (c) {
						...
						if (Array.isArray(c))
							for (var d = c.length - 1; 0 <= d; --d)
								b = Sj(q, a, c[d], Rj(m, n), this.Xi, this) || b;
						else
							b = Sj(q, a, c, Rj(m, n), this.Xi, this) || b;
						a = b
					} else
						a = !1;
					this.s = this.s || a
			...
			l && (l = Qj);
			g = Ea(g, p * m);
			if (!this.s && this.G == m && this.O == h && this.H == l && Ka(this.D, g))
				return !0;
		...
		k.bm = function () {
			this.c && (ig(this.element), Gc(this.c), this.c = null);
			var a = this.Ue();
		...
		function Sn(a) {
			...
			if (b && b.c && c) {
				...
				if ("bottom-right" == f || "center-right" == f || "top-right" == f)
					"" !== a.a.Re && (a.a.Re = b.left = ""), g = Math.round(d[0] - c[0] - g) + "px", a.a.vf != g && (a.a.vf = b.right = g);
				else {
					"" !== a.a.vf && (a.a.vf = b.right = "");
				...
				if ("bottom-left" == f || "bottom-center" ==
					f || "bottom-right" == f)
					"" !== a.a.Cf && (a.a.Cf = b.top = ""), c = Math.round(d[1] - c[1] - e) + "px", a.a.ye != c && (a.a.ye = b.bottom = c);
				else {
					"" !== a.a.ye && (a.a.ye = b.bottom = "");
		...
		k.load = function () {
			0 == this.state && (dj(this, 1), this.B(this, this.P), this.D(null, NaN, null))
		};
		k.tp = function (a, b, c) {
			this.tg(b);
			this.Dj(a);
		...
		Xn.prototype.setMap = function (a) {
		...
		function fo(a, b) {
			...
			if (b && a.c) {
				...
				if (b = a.a.Pa(b))
					a.j(b, b), c = (c = a.Nh()) ? c(b) : b.toString()
			}
		...
		k.cm = function (a) {
			"view" === a.key && ((a = a.oldValue) && Mc(a, Xc("rotation"), this.Pe, this), a = this.a.$(), y(a, Xc("rotation"), this.Pe, this))
		};
		k.Pe = function () {
			this.c.$().ae(this.a.$().Ra())
		};
		...
		function lo(a) {
			...
			a.j = !a.j;
			var b = a.c;
			a.j || b.c || (b.Mc(), jo(a), Lc(b, "postrender", function () {
					ko(this)
				}, a))
		}
		k.xn = function () {
		...
		k.An = function (a) {
			this.l !== a && (this.l = a, this.element.classList.toggle("ol-uncollapsible"), !a && this.j && lo(this))
		};
		k.zn = function (a) {
			this.l && this.j !== a && lo(this)
		};
		k.wn = function () {
			return this.j
		};
		...
		function qo(a) {
			...
			if (b) {
				...
				for (e = 3 * Math.floor(Math.log(a.v * b) / Math.log(10)); ; ) {
					f = po[(e % 3 + 3) % 3] * Math.pow(10, Math.floor(e / 3));
					d = Math.round(f / b);
					if (isNaN(d)) {
		...
		k.Rl = function (a) {
			this.o || a.b.target !== this.element.firstElementChild || (ag(this.a.$(), 1, 1), this.B = a.clientX, this.H = a.clientY, this.o = !0)
		};
		k.Pl = function (a) {
			if (this.o) {
		...
		wo.prototype.j = function (a) {
			a.preventDefault();
			a = this.a.$();
			var b = this.c ? this.c : a.v.C();
			a.Sf(b)
		};
		var xo = document.implementation.createDocument("", "", null);
		function yo(a, b) {
			return xo.createElementNS(a, b)
		}
		function zo(a, b) {
			return Ao(a, b, []).join("")
		}
				...
				h.onload = function () {
					if (!h.status || 200 <= h.status && 300 > h.status) {
						...
						if ("json" == a || "text" == a)
							...
							"xml" == a ? (e = h.responseXML) || (e = Do(h.responseText)) : "arraybuffer" == a && (e = h.response);
						e ? c.call(this, b.Na(e, {
								featureProjection: g
							}), b.rb(e), b.ag()) : d.call(this)
					} else
						d.call(this)
				}
				.bind(this);
		...
		function So(a, b, c) {
			var d;
			c && (d = {
					dataProjection: c.dataProjection ? c.dataProjection : a.rb(b),
		...
		Ro.prototype.ag = function () {
			return null
		};
		function Uo(a, b, c) {
			var d = c ? Nb(c.featureProjection) : null,
			e = c ? Nb(c.dataProjection) : null,
			f;
			d && e && !Wb(d, e) ? a instanceof ff ? f = (b ? a.clone() : a).jb(b ? d : e, b ? e : d) : f = $b(a, e, d) : f = a;
		...
		k.Yb = function (a, b) {
			return this.cd(Wo(a), So(this, a, b))
		};
		k.Na = function (a, b) {
			return this.Lg(Wo(a), So(this, a, b))
		};
		k.dd = function (a, b) {
			return this.Pg(Wo(a), So(this, a, b))
		};
		k.rb = function (a) {
			return this.Sg(Wo(a))
		};
		k.Id = function (a, b) {
			return JSON.stringify(this.kd(a, b))
		};
		k.ac = function (a, b) {
			return JSON.stringify(this.pe(a, b))
		};
		k.ld = function (a, b) {
		...
		k = P.prototype;
		k.Bk = function (a) {
			this.A ? ec(this.A, a.da().slice()) : this.A = a.da().slice();
			this.c.push(this.A.length);
			this.u()
		};
		k.clone = function () {
		...
		k.Nb = function (a, b, c, d) {
			if (d < Ga(this.C(), a, b))
				return d;
			this.j != this.g && (this.o = Math.sqrt(tf(this.A, 0, this.c, this.a, 0)), this.j = this.g);
			return vf(this.A, 0, this.c, this.a, this.o, !1, a, b, c, d)
		};
		k.Nn = function (a, b, c) {
			return "XYM" != this.ja && "XYZM" != this.ja || 0 === this.A.length ? null : Ak(this.A, this.c, this.a, a, void 0 !== b ? b : !1, void 0 !== c ? c : !1)
		};
		k.U = function () {
			return Af(this.A, 0, this.c, this.a)
		};
		k.ob = function () {
			return this.c
		};
		...
		k.Ek = function (a) {
			if (this.A) {
				...
				this.A = a.da().slice(), a = a.ob().slice(), this.c.push();
			this.c.push(a);
			this.u()
		};
		k.clone = function () {
		...
		k.U = function (a) {
			if (void 0 !== a) {
				var b = yi(this).slice();
				Qf(b, this.c, this.a, a)
			} else
				b = this.A;
			return Bf(b, 0, this.c, this.a)
		};
		k.rd = function () {
			return this.c
		};
		...
		k.na = function (a, b) {
			if (a) {
				...
				for (g = a.length; h < g; ++h)
					e = yf(b, e, a[h], c, d[f]), d[f++] = e, e = e[e.length - 1];
				d.length = f;
		...
		function $o(a, b) {
			...
			if ("number" === typeof a.x && "number" === typeof a.y)
				...
				for (h = d.length; l < h; ++l)
					f.length = 0, xf(f, 0, d[l], e.length), Nf(f, 0, f.length, e.length) ? g.push([d[l]]) : c.push(d[l]);
				for (; c.length; ) {
					d = c.shift();
					e = !1;
					for (l = g.length - 1; 0 <= l; l--)
						if (Ka((new Ef(g[l][0])).C(), (new Ef(d)).C())) {
							g[l].push(d);
							e = !0;
							break
						}
		...
		var up = {
			...
			LineString: function (a) {
				return new I(a.paths[0], tp(a))
			},
			Polygon: function (a) {
				return new D(a.rings, tp(a))
			},
			MultiPoint: function (a) {
				return new Q(a.points, tp(a))
			},
			MultiLineString: function (a) {
				return new P(a.paths, tp(a))
			},
			MultiPolygon: function (a) {
				return new R(a.rings, tp(a))
			}
		},
		wp = {
			Point: function (a) {
		...
		k.Sg = function (a) {
			return a.spatialReference && a.spatialReference.wkid ? Nb("EPSG:" + a.spatialReference.wkid) : null
		};
		function xp(a, b) {
			return (0, wp[a.T()])(Uo(a, !0, b), b)
		}
		k.re = function (a, b) {
			return xp(a, To(this, b))
		};
		k.kd = function (a, b) {
			b = To(this, b);
			var c = {},
			d = a.V();
			d && (c.geometry = xp(d, b), b && b.featureProjection && (c.geometry.spatialReference = {
						wkid: Nb(b.featureProjection).ub.split(":").pop()
					}));
			b = a.M();
			delete b[a.a];
			c.attributes = mb(b) ? {}
		...
		k.Yb = function (a, b) {
			return Bo(a) ? zp(this, a, b) : Co(a) ? this.Kg(a, b) : "string" === typeof a ? (a = Do(a), zp(this, a, b)) : null
		};
		function zp(a, b, c) {
			a = Ap(a, b, c);
		...
		k.Na = function (a, b) {
			return Bo(a) ? Ap(this, a, b) : Co(a) ? this.Ic(a, b) : "string" === typeof a ? (a = Do(a), Ap(this, a, b)) : []
		};
		function Ap(a, b, c) {
			var d = [];
			for (b = b.firstChild; b; b = b.nextSibling)
				b.nodeType == Node.ELEMENT_NODE && ec(d, a.Ic(b, c));
			return d
		}
		k.dd = function (a, b) {
			if (Bo(a))
		...
		k.rb = function (a) {
			return Bo(a) ? this.Rg(a) : Co(a) ? this.sf(a) : "string" === typeof a ? (a = Do(a), this.Rg(a)) : null
		};
		k.Rg = function () {
		...
		function Bp(a) {
			...
			this.b["http://www.opengis.net/gml"] = {
				featureMember: Go(Bp.prototype.ee),
				featureMembers: Go(Bp.prototype.ee)
			};
			yp.call(this)
		}
		v(Bp, yp);
			...
			if ("FeatureCollection" == c)
				...
				for (var u in g) {
					...
					for (h = f.length; l < h; ++l)
						(-1 === f[l].indexOf(":") ? "p0" : f[l].split(":")[0]) === u && (n[f[l].split(":").pop()] = "featureMembers" == c ? Fo(this.Jg, this) : Go(this.Jg, this));
					e[g[u]] = n
				}
		...
		k.Jg = function (a, b) {
			...
			for (a = a.firstElementChild; a; a = a.nextElementSibling) {
				...
				if (0 === a.childNodes.length || 1 === a.childNodes.length && (3 === a.firstChild.nodeType || 4 === a.firstChild.nodeType)) {
					...
					"boundedBy" !== f && (e = f), d[f] = this.pf(a, b)
			}
			b = new vk(d);
			e && b.Jc(e);
			c && b.pc(c);
		...
		k.wj = function (a, b) {
			if (a = this.nf(a, b))
				return b = new B(null), b.ba("XYZ", a), b
		};
		k.uj = function (a, b) {
			if (a = O([], this.fk, a, b, this))
				return new Q(a)
		};
		k.tj = function (a, b) {
			if (a = O([], this.ek, a, b, this))
				return b = new P(null), Xo(b, a), b
		};
		k.vj = function (a, b) {
			if (a = O([], this.gk, a, b, this))
				return b = new R(null), Yo(b, a), b
		};
		k.nj = function (a, b) {
			No(this.jk, a, b, this)
		};
		...
		k.Pp = function (a, b) {
			if (a = O(null, this.se, a, b, this))
				return a
		};
		k.sj = function (a, b) {
			if (a = this.nf(a, b))
				return b = new Ef(null), Ff(b, "XYZ", a), b
		};
		k.rf = function (a, b) {
			if ((a = O([null], this.Ef, a, b, this)) && a[0]) {
				b = new D(null);
				var c = a[0],
				d = [c.length],
				e;
				...
				for (e = a.length; f < e; ++f)
					ec(c, a[f]), d.push(c.length);
				b.ba("XYZ", c, d);
				return b
			}
		};
		k.nf = function (a, b) {
			return O(null, this.se, a, b, this)
		};
		k.fk = {
			"http://www.opengis.net/gml": {
				pointMember: Fo(Bp.prototype.nj),
				pointMembers: Fo(Bp.prototype.nj)
			}
		};
		k.ek = {
			"http://www.opengis.net/gml": {
				lineStringMember: Fo(Bp.prototype.ci),
				lineStringMembers: Fo(Bp.prototype.ci)
			}
		};
		k.gk = {
			"http://www.opengis.net/gml": {
				polygonMember: Fo(Bp.prototype.oj),
				polygonMembers: Fo(Bp.prototype.oj)
			}
		};
		k.jk = {
			"http://www.opengis.net/gml": {
				Point: Fo(Bp.prototype.nf)
			}
		};
		k.ck = {
			"http://www.opengis.net/gml": {
				LineString: Fo(Bp.prototype.qf)
			}
		};
		k.kk = {
			"http://www.opengis.net/gml": {
				Polygon: Fo(Bp.prototype.rf)
			}
		};
		k.te = {
			"http://www.opengis.net/gml": {
				LinearRing: Go(Bp.prototype.Pp)
			}
		};
		k.rj = function (a, b) {
			return (a = this.pf(a, [So(this, a, b ? b : {})])) ? a : null
		};
		k.Ic = function (a, b) {
			var c = {
		...
		k.sf = function (a) {
			return Nb(this.srsName ? this.srsName : a.firstElementChild.getAttribute("srsName"))
		};
		function Dp(a) {
			a = zo(a, !1);
			return Ep(a)
		...
		function Mp(a, b) {
			a.appendChild(xo.createTextNode(b.toPrecision()))
		}
		function Np(a, b) {
			a.appendChild(xo.createTextNode(b.toString()))
		}
		function Lp(a, b) {
			a.appendChild(xo.createTextNode(b))
		};
		function Op(a) {
			a = a ? a : {};
			Bp.call(this, a);
		...
		k = Op.prototype;
		k.Tp = function (a, b) {
			if (a = O([], this.dk, a, b, this))
				return b = new P(null), Xo(b, a), b
		};
		k.Up = function (a, b) {
			if (a = O([], this.hk, a, b, this))
				return b = new R(null), Yo(b, a), b
		};
		k.Dh = function (a, b) {
			No(this.$j, a, b, this)
		...
		k.Xp = function (a, b) {
			return O([null], this.ik, a, b, this)
		};
		k.$p = function (a, b) {
			return O([null], this.lk, a, b, this)
		};
		k.Yp = function (a, b) {
			return O([null], this.Ef, a, b, this)
		};
		k.Sp = function (a, b) {
			return O([null], this.se, a, b, this)
		};
		...
		k.xj = function (a, b) {
			if ((a = O([null], this.nk, a, b, this)) && a[0]) {
				b = new D(null);
				var c = a[0],
				d = [c.length],
				e;
		...
		k.pj = function (a, b) {
			if (a = O([null], this.ak, a, b, this))
				return b = new I(null), b.ba("XYZ", a), b
		};
		k.Op = function (a, b) {
			a = O([null], this.bk, a, b, this);
			return Ma(a[1][0], a[1][1], a[2][0], a[2][1])
		};
		k.Qp = function (a, b) {
			var c = zo(a, !1),
			d = /^\s*([+\-]?\d*\.?\d+(?:[eE][+\-]?\d+)?)\s*/;
		...
		k.se = {
			"http://www.opengis.net/gml": {
				pos: Go(Op.prototype.Qp),
				posList: Go(Op.prototype.Og)
			}
		};
		k.Ef = {
			"http://www.opengis.net/gml": {
				interior: Op.prototype.wm,
				exterior: Op.prototype.Vk
			}
		};
		k.ph = {
			"http://www.opengis.net/gml": {
				Point: Go(Bp.prototype.wj),
				MultiPoint: Go(Bp.prototype.uj),
				LineString: Go(Bp.prototype.qf),
				MultiLineString: Go(Bp.prototype.tj),
				LinearRing: Go(Bp.prototype.sj),
				Polygon: Go(Bp.prototype.rf),
				MultiPolygon: Go(Bp.prototype.vj),
				Surface: Go(Op.prototype.xj),
				MultiSurface: Go(Op.prototype.Up),
				Curve: Go(Op.prototype.pj),
				MultiCurve: Go(Op.prototype.Tp),
				Envelope: Go(Op.prototype.Op)
			}
		};
		k.dk = {
			"http://www.opengis.net/gml": {
				curveMember: Fo(Op.prototype.Dh),
				curveMembers: Fo(Op.prototype.Dh)
			}
		};
		k.hk = {
			"http://www.opengis.net/gml": {
				surfaceMember: Fo(Op.prototype.Sj),
				surfaceMembers: Fo(Op.prototype.Sj)
			}
		};
		k.$j = {
			"http://www.opengis.net/gml": {
				LineString: Fo(Bp.prototype.qf),
				Curve: Fo(Op.prototype.pj)
			}
		};
		k.mk = {
			"http://www.opengis.net/gml": {
				Polygon: Fo(Bp.prototype.rf),
				Surface: Fo(Op.prototype.xj)
			}
		};
		k.nk = {
			"http://www.opengis.net/gml": {
				patches: Go(Op.prototype.Xp)
			}
		};
		k.ak = {
			"http://www.opengis.net/gml": {
				segments: Go(Op.prototype.$p)
			}
		};
		k.bk = {
			"http://www.opengis.net/gml": {
				lowerCorner: Fo(Op.prototype.Og),
				upperCorner: Fo(Op.prototype.Og)
			}
		};
		k.ik = {
			"http://www.opengis.net/gml": {
				PolygonPatch: Go(Op.prototype.Yp)
			}
		};
		k.lk = {
			"http://www.opengis.net/gml": {
				LineStringSegment: Go(Op.prototype.Sp)
			}
		};
		function Pp(a, b, c) {
			var d = c[c.length - 1];
		...
		k.Gn = function (a, b, c) {
			...
			Oo({
				node: a
			}, Qp, Lo, [b[0] + " " + b[1], b[2] + " " + b[3]], c, ["lowerCorner", "upperCorner"], this)
		};
		k.Bi = function (a, b, c) {
			var d = c[c.length - 1].srsName;
			d && a.setAttribute("srsName", d);
		...
		k.$e = function (a, b, c) {
			...
			"Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (b = b.Td(), Oo({
					node: a,
					hasZ: e,
					srsName: d
				}, Rp, this.Fn, b, c, void 0, this)) : "Surface" === a.nodeName && (e = yo(a.namespaceURI, "patches"), a.appendChild(e), a = yo(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.$e(a, b, c))
		};
		k.Ze = function (a, b, c) {
			var d = c[c.length - 1].srsName;
			"LineStringSegment" !== a.nodeName && d && a.setAttribute("srsName", d);
			"LineString" === a.nodeName || "LineStringSegment" === a.nodeName ? (d = yo(a.namespaceURI, "posList"), a.appendChild(d), Pp(d, b, c)) : "Curve" === a.nodeName && (d = yo(a.namespaceURI, "segments"), a.appendChild(d), a = yo(d.namespaceURI, "LineStringSegment"), d.appendChild(a), this.Ze(a, b, c))
		};
		k.Di = function (a, b, c) {
			var d = c[c.length - 1],
			e = d.hasZ,
		...
		k.Hn = function (a, b, c) {
			...
			Oo({
				...
				hasZ: d,
				srsName: e
			}, Tp, Jo("pointMember"), b, c, void 0, this)
		};
		k.Ci = function (a, b, c) {
			var d = c[c.length - 1],
			e = d.hasZ,
			...
			Oo({
				...
				srsName: f,
				curve: d
			}, Up, this.l, b, c, void 0, this)
		};
		k.Fi = function (a, b, c) {
			var d = yo(a.namespaceURI, "LinearRing");
			a.appendChild(d);
			this.Bi(d, b, c)
		};
		k.Gi = function (a, b, c) {
		...
		k.zi = function (a, b, c) {
			...
			for (m in g) {
				var l = g[m];
				null !== l && (b.push(m), h.push(l), m == f || l instanceof ff ? m in d.sb[e] || (d.sb[e][m] = L(this.Yc, this)) : m in d.sb[e] || (d.sb[e][m] = L(Lp)))
			}
			var m = jb({}, d);
			m.node = a;
		...
		var Sp = {
			"http://www.opengis.net/gml": {
				surfaceMember: L(Op.prototype.Gi),
				polygonMember: L(Op.prototype.Gi)
			}
		},
		Tp = {
			"http://www.opengis.net/gml": {
				pointMember: L(Op.prototype.In)
			}
		},
		Up = {
			"http://www.opengis.net/gml": {
				lineStringMember: L(Op.prototype.Ai),
				curveMember: L(Op.prototype.Ai)
			}
		},
		Rp = {
			"http://www.opengis.net/gml": {
				exterior: L(Op.prototype.Fi),
				interior: L(Op.prototype.Fi)
			}
		},
		Vp = {
			"http://www.opengis.net/gml": {
		...
		Op.prototype.l = function (a, b) {
			return yo("http://www.opengis.net/gml", Wp[b[b.length - 1].node.nodeName])
		};
		Op.prototype.a = function (a, b) {
			...
			return yo("http://www.opengis.net/gml", a)
		};
		Op.prototype.qe = function (a, b) {
			b = To(this, b);
			var c = yo("http://www.opengis.net/gml", "geom"),
			d = {
				node: c,
				hasZ: this.hasZ,
		...
		k.Mp = function (a, b) {
			a = O([null], this.Zj, a, b, this);
			return Ma(a[1][0], a[1][1], a[1][3], a[1][4])
		};
		k.um = function (a, b) {
			(a = O(void 0, this.te, a, b, this)) && b[b.length - 1].push(a)
		};
		...
		k.se = {
			"http://www.opengis.net/gml": {
				coordinates: Go(Xp.prototype.qj)
			}
		};
		k.Ef = {
			"http://www.opengis.net/gml": {
				innerBoundaryIs: Xp.prototype.um,
				outerBoundaryIs: Xp.prototype.vp
			}
		};
		k.Zj = {
			"http://www.opengis.net/gml": {
				coordinates: Fo(Xp.prototype.qj)
			}
		};
		k.ph = {
			"http://www.opengis.net/gml": {
		...
		k.Xe = function (a, b, c) {
			var d = c[c.length - 1].srsName;
			"LineStringSegment" !== a.nodeName && d && a.setAttribute("srsName", d);
			"LineString" === a.nodeName || "LineStringSegment" === a.nodeName ? (d = Zp(a.namespaceURI), a.appendChild(d), $p(d, b, c)) : "Curve" === a.nodeName && (d = yo(a.namespaceURI, "segments"), a.appendChild(d), a = yo(d.namespaceURI, "LineStringSegment"), d.appendChild(a), this.Xe(a, b, c))
		};
		function Zp(a) {
			a = yo(a, "coordinates");
		...
		k.Ye = function (a, b, c) {
			...
			"Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (b = b.Td(), Oo({
					...
					hasZ: e,
					srsName: d
				}, bq, this.Bn, b, c, void 0, this)) : "Surface" === a.nodeName && (e = yo(a.namespaceURI, "patches"), a.appendChild(e), a = yo(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.Ye(a, b, c))
		};
		k.Bn = function (a, b) {
			a = b[b.length - 1];
			b = a.node;
			var c = a.exteriorWritten;
			void 0 === c && (a.exteriorWritten = !0);
			return yo(b.namespaceURI, void 0 !== c ? "innerBoundaryIs" : "outerBoundaryIs")
		};
		k.xi = function (a, b, c) {
			var d = yo(a.namespaceURI, "LinearRing");
			a.appendChild(d);
		...
		k.Dn = function (a, b, c) {
			...
			Oo({
				...
				hasZ: e,
				srsName: d
			}, dq, Jo("pointMember"), b, c, void 0, this)
		};
		k.En = function (a, b, c) {
			var d = yo(a.namespaceURI, "Point");
			a.appendChild(d);
		...
		k.Cn = function (a, b, c) {
			...
			Oo({
				node: a
			}, fq, Lo, [b[0] + " " + b[1], b[2] + " " + b[3]], c, ["lowerCorner", "upperCorner"], this)
		};
		var Yp = {
			"http://www.opengis.net/gml": {
				Curve: L(Xp.prototype.Xe),
				MultiCurve: L(Xp.prototype.ui),
				Point: L(Xp.prototype.wi),
				MultiPoint: L(Xp.prototype.Dn),
				LineString: L(Xp.prototype.Xe),
				MultiLineString: L(Xp.prototype.ui),
				LinearRing: L(Xp.prototype.ti),
				Polygon: L(Xp.prototype.Ye),
				MultiPolygon: L(Xp.prototype.vi),
				Surface: L(Xp.prototype.Ye),
				MultiSurface: L(Xp.prototype.vi),
				Envelope: L(Xp.prototype.Cn)
			}
		},
		bq = {
			"http://www.opengis.net/gml": {
				outerBoundaryIs: L(Xp.prototype.xi),
				innerBoundaryIs: L(Xp.prototype.xi)
			}
		},
		dq = {
			"http://www.opengis.net/gml": {
				pointMember: L(Xp.prototype.En)
			}
		},
		cq = {
			"http://www.opengis.net/gml": {
				lineStringMember: L(Xp.prototype.si),
				curveMember: L(Xp.prototype.si)
			}
		};
		Xp.prototype.a = function (a, b) {
			return yo("http://www.opengis.net/gml", gq[b[b.length - 1].node.nodeName])
		};
		var gq = {
			MultiLineString: "lineStringMember",
			MultiCurve: "curveMember",
		...
		eq = {
			"http://www.opengis.net/gml": {
				surfaceMember: L(Xp.prototype.yi),
				polygonMember: L(Xp.prototype.yi)
			}
		},
		fq = {
			"http://www.opengis.net/gml": {
		...
		hq.prototype.Kg = function (a, b) {
			if (!cc(iq, a.namespaceURI))
				return null;
			var c = uq[a.localName];
			if (!c)
				return null;
			a = c(a, [So(this, a, b)]);
			if (!a)
		...
		hq.prototype.Ic = function (a, b) {
			return cc(iq, a.namespaceURI) ? "gpx" == a.localName && (a = O([], vq, a, [So(this, a, b)])) ? (zq(this, a), a) : [] : []
		};
		function Aq(a, b, c) {
			...
			Oo({
				node: a
			}, Bq, Lo, [b.linkText, b.linkType], c, Cq)
		}
		function Dq(a, b, c) {
			var d = c[c.length - 1],
		...
		function Oq(a, b) {
			if (a = a.V())
				if (a = Nq[a.T()])
					return yo(b[b.length - 1].node.namespaceURI, a)
		}
		var Pq = M(iq, {
				rte: L(function (a, b, c) {
					...
					if (b = b.V())
						b = Uo(b, !0, d), a.geometryLayout = b.ja, e.rtept = b.U();
				...
				wpt: L(function (a, b, c) {
					...
					e.properties = b.M();
					if (b = b.V())
						b = Uo(b, !0, d), e.geometryLayout = b.ja, Dq(a, b.U(),
							c)
				})
			});
		hq.prototype.bc = function (a, b) {
			b = To(this, b);
			var c = yo("http://www.topografix.com/GPX/1/1", "gpx");
		...
		k.Vd = function (a) {
			...
			if (e)
				return a = new Qq(null), Tq(a), a.a = c, Rq(a), a.u(), this.i[b] = a;
			this.f = a;
			return this
		};
		k.T = function () {
		...
		v(Uq, Vo);
		function Vq(a, b) {
			return a ? Uo((0, Wq[a.type])(a), !1, b) : null
		}
		function Xq(a, b) {
			return (0, Yq[a.T()])(Uo(a, !0, b), b)
		}
		var Wq = {
			Point: function (a) {
		...
		k.Sg = function (a) {
			a = a.crs;
			var b;
			a ? "name" == a.type ? b = Nb(a.properties.name) : na(!1, 36) : b = this.defaultDataProjection;
			return b
		};
		k.kd = function (a, b) {
			b = To(this, b);
			...
			b = a.M();
			delete b[a.a];
			mb(b) ? c.properties = null : c.properties = b;
			return c
		};
		k.pe = function (a, b) {
			b = To(this, b);
		...
		k.Yb = function (a, b) {
			return this.de($q(a), To(this, b))
		};
		k.Na = function (a, b) {
			return this.Mg($q(a), To(this, b))
		};
		k.dd = function (a, b) {
			return this.Fd($q(a), To(this, b))
		};
		k.rb = function () {
			return this.defaultDataProjection
		};
		k.Id = function (a, b) {
			return this.oe(a, To(this, b))
		};
		k.ac = function (a, b) {
			return this.mh(a, To(this, b))
		};
		k.ld = function (a, b) {
			return this.Jd(a, To(this, b))
		};
		function ar(a) {
			a = a ? a : {};
			Ro.call(this);
		...
		k.de = function (a, b) {
			...
			for (m = d.length; n < m; ++n) {
				...
				if ("B" == p.charAt(0)) {
					...
					"H" == p.charAt(0) && ((q = dr.exec(p)) ? (h = parseInt(q[1], 10), g = parseInt(q[2], 10) - 1, f = 2E3 + parseInt(q[3], 10)) : (q = cr.exec(p)) && (a[q[1]] = q[2].trim()))
			}
			if (0 === e.length)
				return null;
			d = new I(null);
		...
		fr.prototype.o = function () {
			...
			if (!this.s && null !== this.f) {
				...
				for (var b = a.getImageData(0, 0, this.N.width, this.N.height), c = b.data, d = this.f[0] / 255, e = this.f[1] / 255, f = this.f[2] / 255, g = 0, h = c.length; g < h; g += 4)
		...
		fr.prototype.load = function () {
			if (0 == this.g) {
				this.g = 1;
				this.i = [Lc(this.N, "error", this.v, this), Lc(this.N, "load", this.o, this)];
				try {
					this.N.src = this.l
				} catch (a) {
					this.v()
		...
		k.Uc = function () {
			...
			var a = this.l,
			b = this.nc();
			if ("fraction" == this.B || "fraction" == this.H) {
				if (!b)
					return null;
				a = this.l.slice();
				"fraction" == this.B && (a[0] *= b[0]);
				"fraction" == this.H && (a[1] *= b[1])
			}
			if ("top-left" != this.g) {
				if (!b)
					return null;
		...
		function ir(a) {
			a = a ? a : {};
			yp.call(this);
			jr || (kr = [255, 255, 255, 1], lr = new nk({
						color: kr
					}), mr = [20, 2], nr = or = "pixels", pr = [64, 64], qr = "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png", rr = .5, sr = new hr({
						anchor: mr,
		...
		function Cr(a, b, c, d, e) {
			return function () {
				...
				if (a)
					return f ? (f = Br(a[0], g), a.concat(f)) : a;
				if (b) {
					var h = Dr(b, c, d);
					return f ? (f = Br(h[0], g), h.concat(f)) : h
				}
				return f ? (f = Br(c[0], g), c.concat(f)) : c
			}
		}
		function Dr(a, b, c) {
			return Array.isArray(a) ? a : "string" === typeof a ? (!(a in c) && "#" + a in c && (a = "#" + a), Dr(c[a], b, c)) : b
		}
		function Er(a) {
			a = zo(a, !1);
		...
		function Mr(a, b) {
			var c = O({}, Nr, a, b);
			if (a = O(null, Or, a, b))
				return b = new I(null), b.ba("XYZ", a), b.I(c), b
		}
		function Pr(a, b) {
			var c = O({}, Nr, a, b);
			if (a = O(null, Or, a, b))
				return b = new D(null), b.ba("XYZ", a, [a.length]), b.I(c), b
		}
		function Qr(a, b) {
			a = O([], Rr, a, b);
			if (!a)
			...
			if (c)
				if ("Point" == d) {
					...
					"LineString" == d ? (g = new P(null), Xo(g, a), Sr(g, a)) : "Polygon" == d ? (g = new R(null), Yo(g, a), Sr(g, a)) : "GeometryCollection" == d ? g = new Qq(a) : na(!1, 37);
			else
				g = new Qq(a);
			return g
		}
		function Tr(a, b) {
			var c = O({}, Nr, a, b);
			if (a = O(null, Or, a, b))
				return b = new B(null), b.ba("XYZ", a), b.I(c), b
		}
		function Ur(a, b) {
			var c = O({}, Nr, a, b);
			if ((a = O([null], Vr, a, b)) && a[0]) {
				b = new D(null);
				var d = a[0],
				e = [d.length],
				f;
		...
		function Wr(a, b) {
			...
			if (!b)
				return null;
			a = "fillStyle" in b ? b.fillStyle : lr;
			var c = b.fill;
			void 0 === c || c || (a = null);
			c = "imageStyle" in b ? b.imageStyle : sr;
			c == tr && (c = void 0);
			var d = "textStyle" in b ? b.textStyle : wr,
		...
		Vr = M(zr, {
				innerBoundaryIs: function (a, b) {
					(a = O(void 0, fs, a, b)) && b[b.length - 1].push(a)
				},
		...
		qs = M(zr, {
				...
				StyleMap: function (a, b) {
					if (a = O(void 0, ps, a, b))
						b = b[b.length - 1], Array.isArray(a) ? b.Style = a : "string" === typeof a ? b.styleUrl = a : na(!1, 38)
				},
				address: K(S),
				description: K(S),
				name: K(S),
		...
		Xr = M(zr, {
				IconStyle: function (a, b) {
					if (a = O({}, is, a, b)) {
						...
						if (g) {
							...
							e === qr ? (h = mr, l = or, m = nr) : /^http:\/\/maps\.(?:google|gstatic)\.com\//.test(e) && (h = [.5, 0], m = l = "fraction");
						var n;
						g = c.x;
						var p = c.y;
						...
						void 0 !== c && (r = ua(c));
						a = a.scale;
						d ? (e == qr && (q = pr, void 0 === a && (a = rr)), e = new hr({
									anchor: h,
									anchorOrigin: f,
									anchorXUnits: l,
									anchorYUnits: m,
									...
									size: q,
									src: e
								}), b.imageStyle = e) : b.imageStyle = tr
					}
				},
				...
				LineStyle: function (a, b) {
					(a = O({}, ks, a, b)) && (b[b.length - 1].strokeStyle = new ok({
		...
		k.Ig = function (a, b) {
			var c = M(zr, {
					Document: Eo(this.Ig, this),
					Folder: Eo(this.Ig, this),
					Placemark: Fo(this.Qg, this),
					Style: this.bq.bind(this),
					StyleMap: this.aq.bind(this)
				});
			if (a = O([], c, a, b, this))
				return a
		};
		...
		k.Kg = function (a, b) {
			return cc(zr, a.namespaceURI) ? (a = this.Qg(a, [So(this, a, b)])) ? a : null : null
		};
		k.Ic = function (a, b) {
			if (!cc(zr, a.namespaceURI))
				return [];
			var c = a.localName;
			if ("Document" == c || "Folder" == c)
				return (c = this.Ig(a, [So(this, a, b)])) ? c : [];
			if ("Placemark" == c)
				return (b = this.Qg(a, [So(this, a, b)])) ? [b] : [];
			if ("kml" == c) {
				c = [];
				for (a = a.firstElementChild; a; a = a.nextElementSibling) {
					var d = this.Ic(a, b);
		...
		function ts(a, b) {
			...
			for (c = b.firstElementChild; c; c = c.nextElementSibling)
				if (cc(zr, c.namespaceURI) && "name" == c.localName)
					return S(c);
			for (c = b.firstElementChild; c; c = c.nextElementSibling)
				if (b = c.localName, cc(zr, c.namespaceURI) && ("Document" == b || "Folder" == b || "Placemark" == b || "kml" == b) && (b = ts(a, c)))
					return b
		}
		k.Wp = function (a) {
			var b = [];
			Bo(a) ? ec(b, us(this, a)) : Co(a) ? ec(b, vs(this, a)) : "string" === typeof a && (a = Do(a), ec(b, us(this, a)));
			return b
		};
		function us(a, b) {
			var c = [];
			for (b = b.firstChild; b; b = b.nextSibling)
				b.nodeType == Node.ELEMENT_NODE && ec(c, vs(a, b));
			return c
		}
		function vs(a, b) {
			var c,
			d = [];
			for (c = b.firstElementChild; c; c = c.nextElementSibling)
				if (cc(zr, c.namespaceURI) && "NetworkLink" == c.localName) {
					var e = O({}, ns, c, []);
					d.push(e)
				}
			for (c = b.firstElementChild; c; c = c.nextElementSibling)
				b = c.localName, !cc(zr, c.namespaceURI) || "Document" != b && "Folder" != b && "kml" != b || ec(d, vs(a, c));
			return d
		}
		k.Zp = function (a) {
			var b = [];
			Bo(a) ? ec(b, ws(this, a)) : Co(a) ? ec(b, this.tf(a)) : "string" === typeof a && (a = Do(a), ec(b, ws(this, a)));
			return b
		};
		function ws(a, b) {
			var c = [];
			for (b = b.firstChild; b; b = b.nextSibling)
				b.nodeType == Node.ELEMENT_NODE && ec(c, a.tf(b));
			return c
		}
		k.tf = function (a) {
			var b,
			...
			for (b = a.firstElementChild; b; b = b.nextElementSibling)
				if (cc(zr, b.namespaceURI) && "Region" == b.localName) {
					var d = O({}, as, b, []);
					c.push(d)
				}
			for (b = a.firstElementChild; b; b = b.nextElementSibling)
				a = b.localName, !cc(zr, b.namespaceURI) || "Document" != a && "Folder" != a && "kml" != a || ec(c, this.tf(b));
			return c
		};
		function xs(a, b) {
			b = li(b);
		...
		function ys(a, b, c) {
			...
			if ("GeometryCollection" == d) {
				...
				"MultiPoint" == d ? (e = b.be(), f = As) : "MultiLineString" == d ? (e = b.ud(), f = Bs) : "MultiPolygon" == d ? (e = b.Ud(), f = Cs) : na(!1, 39);
			Oo(a, Ds, f, e, c)
		}
		function Es(a, b, c) {
			Oo({
		...
		Xs = M(zr, {
				Data: L(function (a, b, c) {
					...
					b = b.value;
					"object" == typeof b ? (null !== b && b.displayName && Oo(a, Xs, Lo, [b.displayName], c, ["displayName"]), null !== b && b.value && Oo(a, Xs, Lo, [b.value], c, ["value"])) : Oo(a, Xs, Lo, [b], c, ["value"])
				}),
				value: L(function (a, b) {
					Lp(a, b)
				}),
				displayName: L(function (a, b) {
					a.appendChild(xo.createCDATASection(b))
				})
			}),
		Ys = {
			Point: "Point",
		...
		Ns = M(zr, {
				...
				coordinates: L(function (a, b, c) {
					...
					c = c.stride;
					var e;
					"XY" == d || "XYM" == d ? e = 2 : "XYZ" == d || "XYZM" == d ? e = 3 : na(!1, 34);
					var f,
					g = b.length,
					h = "";
					if (0 < g) {
		...
		Ps = M(zr, {
				outerBoundaryIs: L(Es),
				innerBoundaryIs: L(Es)
			}),
		kt = M(zr, {
				color: L(xs)
			}),
		...
		jt = M(zr, {
				...
				LineStyle: L(function (a, b, c) {
					...
					var d = ft[c[c.length - 1].node.namespaceURI];
					b = Mo({
							color: b.a,
							width: b.c
						}, d);
		...
		function Vs(a, b) {
			return yo(b[b.length - 1].node.namespaceURI, "Placemark")
		}
		function zs(a, b) {
			if (a)
				return yo(b[b.length - 1].node.namespaceURI, Ys[a.T()])
		}
		var lt = Jo("color"),
		ht = Jo("Data"),
		Js = Jo("ExtendedData"),
		...
		(function (a) {
			function b(a) {
				this.sc = ArrayBuffer.isView && ArrayBuffer.isView(a) ? a : new Uint8Array(a || 0);
				this.type = this.ga = 0;
			...
			b.prototype = {
				...
				Rp: function () {
					var a = e.read(this.sc, this.ga, !0, 23, 4);
					this.ga += 4;
					return a
				},
				Np: function () {
					var a = e.read(this.sc, this.ga, !0, 52, 8);
					this.ga += 8;
					return a
				},
				Ta: function (a) {
		...
		k.ob = mt.prototype.rd = function () {
			return this.g
		};
		k.C = function () {
			this.i || (this.i = "Point" === this.f ? Oa(this.b) : Pa(this.b, 0, this.b.length, 2));
			return this.i
		};
		k.Sd = function () {
			if (!this.c) {
				var a = cb(this.C());
				this.c = Jf(this.b, 0, this.g, 2, a, 0)
			}
			return this.c
		};
		k.Ee = function () {
			this.a || (this.a = yk(this.b, 0, this.b.length, 2, .5));
			return this.a
		};
		k.Fe = function () {
			if (!this.a) {
		...
		function nt(a) {
			Ro.call(this);
			a = a ? a : {};
			this.defaultDataProjection = new vb({
					code: "EPSG:3857",
					units: "tile-pixels"
				});
		...
		function pt(a, b, c) {
			if (15 === a)
				...
				a = null;
				for (var d = c.Ta() + c.ga; c.ga < d; )
					a = c.Ta() >> 3, a = 1 === a ? c.Ug() : 2 === a ? c.Rp() : 3 === a ? c.Np() : 4 === a ? c.cq() : 5 === a ? c.Ta() : 6 === a ? c.Tg() : 7 === a ? c.Lp() : null;
				b.values.push(a)
			}
		}
		function qt(a, b, c) {
			if (1 == a)
				...
				for (a = c.Ta() + c.ga; c.ga < a; ) {
					var d = b.layer.keys[c.Ta()],
					e = b.layer.values[c.Ta()];
					b.properties[d] = e
				}
			else
				3 == a ? b.type = c.Ta() : 4 == a && (b.geometry = c.ga)
		}
		function rt(a, b, c) {
			var d = c.type;
			if (0 === d)
			...
			for (var m = 1, n = 0, p = 0, q = 0, r = 0, u = 0; b.ga < c; )
				n || (n = b.Ta(), m = n & 7, n >>= 3), n--, 1 === m || 2 === m ? (p += b.Tg(), q += b.Tg(), 1 === m && r > u && (l.push(r), u = r), g.push(p, q), r += 2) : 7 === m ? r > u && (g.push(g[u], g[u + 1]), r += 2) : na(!1, 59);
			r > u && l.push(r);
			b = h.length;
			var x;
			...
			if (a.b === mt)
				...
				if ("Polygon" == d) {
					...
					for (c = h.length; l < c; ++l)
						m = h[l], Nf(g, x, m, 2) || (d.push(h.slice(b, l)), b = l), x = m;
					1 < d.length ? (h = d, d = new R(null)) : d = new D(null)
				} else
					d = "Point" === d ? new B(null) : "LineString" === d ? new I(null) : "Polygon" === d ? new D(null) : "MultiPoint" === d ? new Q(null) : "MultiLineString" === d ? new P(null) : null;
				d.ba("XY", g, h);
				g = new a.b;
				a.g && g.Jc(a.g);
		...
		v(st, yp);
		function tt(a, b) {
			b[b.length - 1].ke[a.getAttribute("k")] = a.getAttribute("v")
		}
		var ut = [null],
		vt = M(ut, {
				nd: function (a, b) {
					b[b.length - 1].xd.push(a.getAttribute("ref"))
				},
				tag: tt
			}),
		xt = M(ut, {
				node: function (a, b) {
					...
					mb(a.ke) || (f = new B(f), Uo(f, !1, c), c = new vk(f), c.pc(e), c.I(a.ke), d.features.push(c))
				},
				way: function (a, b) {
					var c = a.getAttribute("id");
					a = O({
		...
		st.prototype.Ic = function (a, b) {
			...
			if ("osm" == a.localName) {
				...
				for (var c = 0; c < a.kh.length; c++) {
					for (var d = a.kh[c], e = [], f = 0, g = d.xd.length; f < g; f++)
						ec(e, a.hi[d.xd[f]]);
		...
		k.Fd = function (a, b) {
			...
			yt(a, a.length, c, a);
			c = zf(a, 0, a.length, c);
			return Uo(new I(c, this.a), !1, To(this, b))
		};
		k.oe = function (a, b) {
			if (a = a.V())
				return this.Jd(a, b);
		...
		Et.prototype.Lg = function (a, b) {
			if ("Topology" == a.type) {
				...
				g = this.a;
				for (var z in a)
					this.b && -1 == this.b.indexOf(z) || ("GeometryCollection" === a[z].type ? (l = a[z], e.push.apply(e, Gt(l, f, c, d, g, z, b))) : (l = a[z], e.push(Ht(l, f, c, d, g, z, b))));
				return e
			}
			return []
		};
		...
		v(St, Qt);
		function Tt(a, b, c) {
			St.call(this, "PropertyIsEqualTo", a, b, c)
		}
		v(Tt, St);
		function Ut(a, b) {
			St.call(this, "PropertyIsGreaterThan", a, b)
		}
		v(Ut, St);
		function Vt(a, b) {
			St.call(this, "PropertyIsGreaterThanOrEqualTo", a, b)
		}
		v(Vt, St);
		function Wt(a, b, c) {
			Ot.call(this, "Intersects", a, b, c)
		}
		v(Wt, Ot);
		function Xt(a, b, c) {
			Qt.call(this, "PropertyIsBetween", a);
			this.a = b;
			this.g = c
		}
		v(Xt, Qt);
		function Yt(a, b, c, d, e, f) {
			Qt.call(this, "PropertyIsLike", a);
			this.c = b;
			this.f = void 0 !== c ? c : "*";
			this.i = void 0 !== d ? d : ".";
			this.g = void 0 !== e ? e : "!";
		...
		v(Yt, Qt);
		function Zt(a) {
			Qt.call(this, "PropertyIsNull", a)
		}
		v(Zt, Qt);
		function $t(a, b) {
			St.call(this, "PropertyIsLessThan", a, b)
		}
		v($t, St);
		function au(a, b) {
			St.call(this, "PropertyIsLessThanOrEqualTo", a, b)
		}
		v(au, St);
		function bu(a) {
			this.qc = "Not";
		...
		v(bu, Kt);
		function cu(a, b, c) {
			St.call(this, "PropertyIsNotEqualTo", a, b, c)
		}
		v(cu, St);
		function du(a) {
		...
		v(du, Lt);
		function eu(a, b, c) {
			Ot.call(this, "Within", a, b, c)
		}
		v(eu, Ot);
		function fu(a) {
			var b = [null].concat(Array.prototype.slice.call(arguments));
			return new(Function.prototype.bind.apply(Mt, b))
		}
		function gu(a, b, c) {
			return new Nt(a, b, c)
		};
		...
		uu.prototype.f = function (a) {
			if (Bo(a))
				return yu(this, a);
			if (Co(a))
				return zu(this, a);
			if ("string" === typeof a)
				return a = Do(a), yu(this, a)
		};
		function yu(a, b) {
			for (b = b.firstChild; b; b = b.nextSibling)
				if (b.nodeType == Node.ELEMENT_NODE)
		...
		var Au = {
			"http://www.opengis.net/gml": {
				boundedBy: K(Bp.prototype.pf, "bounds")
			}
		};
		function zu(a, b) {
			var c = {},
		...
		function Fu(a, b) {
			var c = yo("http://www.opengis.net/ogc", "Filter"),
			...
			"http://www.opengis.net/wfs": {
				Insert: L(function (a, b, c) {
					...
					if (2 === e) {
						...
						for (n in h) {
							var m = h[n];
							null !== m && (b.push(n), l.push(m), n == g || m instanceof ff ? n in e.sb[f] || (e.sb[f][n] = L(a.ri, a)) : n in e.sb[f] || (e.sb[f][n] = L(Lp)))
						}
						var n = jb({}, e);
						n.node = d;
						Oo(n, e.sb, Jo(void 0, f), l, c, b)
					} else
						Op.prototype.zi(d,
							b, c)
				}),
		...
		function Nu(a, b, c) {
			a = yo("http://www.opengis.net/ogc", a);
			Lp(a, c);
			b.appendChild(a)
		}
		function Lu(a, b) {
		...
		function Ou(a, b) {
			var c = yo("http://www.opengis.net/gml", "TimeInstant");
			a.appendChild(c);
		...
		var Ju = {
			"http://www.opengis.net/wfs": {
				Query: L(function (a, b, c) {
					...
					b = jb({}, d);
					b.node = a;
					Oo(b, Eu, Jo("PropertyName"), g, c);
					if (d = d.filter)
						g = yo("http://www.opengis.net/ogc", "Filter"), a.appendChild(g), Oo({
							node: g
						}, Ju, Jo(d.qc), [d], c)
				})
			},
			"http://www.opengis.net/ogc": {
				...
				PropertyIsBetween: L(function (a, b) {
					Lu(a, b.b);
					var c = yo("http://www.opengis.net/ogc", "LowerBoundary");
					a.appendChild(c);
					Mu(c, "" + b.a);
		...
		uu.prototype.s = function (a) {
			...
			if (a) {
				...
				var c =
					a.filter;
				if (a.bbox) {
					na(a.geometryName, 12);
					var d = gu(a.geometryName, a.bbox, a.srsName);
					c ? c = fu(c, d) : c = d
				}
			}
		...
		uu.prototype.v = function (a, b, c, d) {
			...
			d.nativeElements && Oo({
				...
				gmlVersion: h,
				srsName: d.srsName
			}, Hu, Jo("Native"), d.nativeElements,
				e);
			return f
		};
		uu.prototype.Rg = function (a) {
			for (a = a.firstChild; a; a = a.nextSibling)
				if (a.nodeType == Node.ELEMENT_NODE)
					return this.sf(a);
			return null
		};
		uu.prototype.sf = function (a) {
		...
		k = Pu.prototype;
		k.de = function (a, b) {
			return (a = this.Fd(a, b)) ? (b = new vk, b.Ua(a), b) : null
		};
		k.Mg = function (a, b) {
			var c = [];
			a = this.Fd(a, b);
			...
			b = [];
			for (var d = 0, e = c.length; d < e; ++d)
				a = new vk, a.Ua(c[d]), b.push(a);
			return b
		};
		k.Fd = function (a, b) {
			a = new Vu(new Wu(a));
			Xu(a);
			return (a = Yu(a)) ? Uo(a, !1, b) : null
		};
		k.oe = function (a, b) {
			return (a = a.V()) ? this.Jd(a, b) : ""
		};
		k.mh = function (a, b) {
			if (1 == a.length)
				return this.oe(a[0], b);
		...
		function fv(a) {
			for (var b = [ev(a)]; $u(a, 5); )
				b.push(ev(a));
			return b
		}
		function gv(a) {
			for (var b = [a.Fg()]; $u(a, 5); )
				b.push(a.Fg());
			return b
		}
		function av(a) {
		...
		cv = {
			POINT: Vu.prototype.Gg,
			LINESTRING: Vu.prototype.Fg,
			POLYGON: Vu.prototype.Hg,
			MULTIPOINT: Vu.prototype.yp,
			MULTILINESTRING: Vu.prototype.xp,
			MULTIPOLYGON: Vu.prototype.zp
		};
		function hv(a) {
		...
		iv.prototype.read = function (a) {
			return Bo(a) ? this.a(a) : Co(a) ? this.b(a) : "string" === typeof a ? (a = Do(a), this.a(a)) : null
		};
		function jv() {
			this.version = void 0
		}
		...
		function pv(a, b) {
			if (b = lv(a, b))
				return a = [Jp(a.getAttribute("width")), Jp(a.getAttribute("height"))], b.size = a, b
		}
		function qv(a, b) {
			return O([], rv, a, b)
		}
		...
		yv = M(sv, {
				...
				ContactVoiceTelephone: K(S),
				ContactFacsimileTelephone: K(S),
				ContactElectronicMailAddress: K(S)
			}),
		zv = M(sv, {
				ContactPerson: K(S),
				ContactOrganization: K(S)
			}),
		Av = M(sv, {
				AddressType: K(S),
				Address: K(S),
		...
		xv = M(sv, {
				...
				BoundingBox: Ho(function (a) {
					var b = [Hp(a.getAttribute("minx")), Hp(a.getAttribute("miny")), Hp(a.getAttribute("maxx")), Hp(a.getAttribute("maxy"))],
					c = [Hp(a.getAttribute("resx")), Hp(a.getAttribute("resy"))];
					return {
				...
				Layer: Ho(function (a, b) {
					...
					d = O({}, xv, a, b);
					if (d)
						return b = Ep(a.getAttribute("queryable")), void 0 === b && (b = c.queryable), d.queryable = void 0 !== b ? b : !1, b = Jp(a.getAttribute("cascaded")), void 0 === b && (b = c.cascaded), d.cascaded = b, b = Ep(a.getAttribute("opaque")), void 0 === b && (b = c.opaque), d.opaque = void 0 !== b ? b : !1, b = Ep(a.getAttribute("noSubsets")), void 0 === b && (b = c.noSubsets), d.noSubsets =
							void 0 !== b ? b : !1, (b = Hp(a.getAttribute("fixedWidth"))) || (b = c.fixedWidth), d.fixedWidth = b, (a = Hp(a.getAttribute("fixedHeight"))) || (a = c.fixedHeight), d.fixedHeight = a, ["Style", "CRS", "AuthorityURL"].forEach(function (a) {
		...
		vv = M(sv, {
				GetCapabilities: K(nv),
				GetMap: K(nv),
				GetFeatureInfo: K(nv)
			}),
		ov = M(sv, {
				Format: Ho(S),
				DCPType: Ho(function (a, b) {
					return O({}, Ev, a, b)
				})
			}),
		Ev = M(sv, {
		...
		Gv.prototype.Ic = function (a, b) {
			...
			if (0 !== a.childNodes.length) {
				...
				"FeatureCollection" == d && (a = O([], this.b.b, a, [{}
							], this.b)) && (b = a)
			}
			return b
		};
		...
		Nv = M(Jv, {
				DeliveryPoint: K(S),
				City: K(S),
				AdministrativeArea: K(S),
				PostalCode: K(S),
				Country: K(S),
				ElectronicMailAddress: K(S)
			}),
		Ov = M(Jv, {
				Value: Ho(function (a) {
					return S(a)
		...
		cw = M($v, {
				...
				Format: Ho(S),
				TileMatrixSetLink: Ho(function (a, b) {
					return O({}, fw, a, b)
				}),
				Dimension: Ho(function (a, b) {
					return O({}, gw, a, b)
				}),
		...
		iw = M($v, {
				TileMatrixLimits: Fo(function (a, b) {
					return O({}, jw, a, b)
				})
			}),
		jw = M($v, {
		...
		dw = M($v, {
				WellKnownScaleSet: K(S),
				TileMatrix: Ho(function (a, b) {
					return O({}, kw, a, b)
				})
			}, M(aw, {
					SupportedCRS: K(S),
		...
		k.Nb = function (a, b, c, d) {
			...
			if (b < d) {
				if (0 === b)
					...
					for (d = this.zd() / Math.sqrt(b), c[0] = e[0] + d * a, c[1] = e[1] + d * f, d = 2; d < this.a; ++d)
						c[d] = e[d];
				c.length = this.a;
				return b
			}
		...
		k.ze = function (a) {
			var b = this.A,
			c = b[this.a] - b[0];
			return Ma(b[0] - c, b[1] - c, b[0] + c, b[1] + c, a)
		};
		k.zd = function () {
			return Math.sqrt(mw(this))
		};
		function mw(a) {
			var b = a.A[a.a] - a.A[0];
			a = a.A[a.a + 1] - a.A[1];
		...
		k.$a = function (a) {
			var b = this.C();
			return fb(a, b) ? (b = this.wa(), a[0] <= b[0] && a[2] >= b[0] || a[1] <= b[1] && a[3] >= b[1] ? !0 : Ua(a, this.Bb, this)) : !1
		};
		k.tb = function (a) {
			var b = this.a,
			c = a.slice();
		...
		nw.prototype.Ha = function (a) {
			Hg.prototype.Ha.call(this, a);
			a ? sw(this) : tw(this)
		};
		nw.prototype.setMap = function (a) {
			tw(this);
		...
		function vw(a) {
			return bh(a) && this.s(a) ? (ag(a.map.$(), 1, 1), this.a = this.f = void 0, !0) : !1
		};
		function T(a) {
			a = a ? a : {};
			var b = jb({}, a);
		...
		function Cw(a, b, c) {
			a.s[b] = [y(c, "change", a.dj, a), y(c, "propertychange", a.dj, a)]
		}
		function Bw(a, b, c) {
			var d = !0,
			e = c.c;
			void 0 !== e ? e.toString()in a.j ? d = !1 : a.j[e.toString()] = c : (na(!(b in a.l), 30), a.l[b] = c);
			return d
		}
		k.Oc = function (a) {
			zw(this, a);
		...
		function zw(a, b) {
			...
			for (c = e.length; g < c; g++)
				h = e[g], l = w(h).toString(), Cw(a, l, h), (b = h.V()) ? (l = b.C(), d.push(l), f.push(h)) : a.f[l] = h;
			a.a && a.a.load(d, f);
			g = 0;
			for (c = e.length; g < c; g++)
				a.b(new Dw("addfeature", e[g]))
		}
		function Aw(a, b) {
			var c = !1;
		...
		k.dc = function (a, b, c) {
			if (this.a)
				return pm(this.a, a, b, c);
			if (this.i)
				return this.i.forEach(b, c)
		};
		k.Jh = function (a, b, c) {
			return this.dc(a, function (d) {
				if (d.V().$a(a) && (d = b.call(c, d)))
					return d
			})
		};
		k.Qh = function () {
		...
		k.ce = function () {
			if (this.i)
				...
				this.a && (a = mm(this.a), mb(this.f) || ec(a, lb(this.f)));
			return a
		};
		k.Ph = function (a) {
			var b = [];
			Ew(this, a, function (a) {
				b.push(a)
			});
			return b
		};
		...
		function Gw(a) {
			...
			if (!b)
				if ("Circle" === this.O)
					...
					b = function (a, b) {
						b ? d === Lw ? b.na([a[0].concat([a[0][0]])]) : b.na(a) : b = new c(a);
						return b
					}
				}
			this.ab = b;
		...
		function Iw(a) {
			this.o = this.f !== Mw && this.Gf(a);
			var b = !0;
			this.o && "pointerdrag" === a.type && null !== this.j ? (Pw(this, a), b = !1) : this.o && "pointerdown" === a.type ? b = !1 : "pointermove" === a.type ? b = Qw(this, a) : "dblclick" === a.type && (b = !1);
			return eh.call(this, a) && b
		}
		function Hw(a) {
			this.W = !this.o;
			return this.o ? (this.ca = a.pixel, this.s || Rw(this, a), !0) : this.Sk(a) ? (this.ca = a.pixel, !0) : !1
		}
		function Jw(a) {
			var b = !0;
			Qw(this, a);
			var c = this.f === Sw;
			this.W ? (this.s ? this.o || c ? this.Od() : Tw(this, a) ? this.Ld(a) && this.Od() : Pw(this, a) : (Rw(this, a), this.f === Mw && this.Od()), b = !1) : this.o && (this.s = null, Uw(this));
			return b
		}
		function Qw(a, b) {
			if (a.ca && (!a.o && a.W || a.o && !a.W)) {
				var c = a.ca,
				d = b.pixel,
				e = c[0] - d[0];
				c = c[1] - d[1];
		...
		function Tw(a, b) {
			...
			if (a.j) {
				var d = !1,
				e = [a.s];
				a.f === Nw ? d = a.a.length > a.ya : a.f === Lw && (d = a.a[0].length > a.ya, e = [a.a[0][0], a.a[0][a.a[0].length - 2]]);
				if (d) {
					d = b.map;
					for (var f = 0, g = e.length; f < g; f++) {
						...
						c = m[0] - l[0];
						l = m[1] - l[1];
						if (c = Math.sqrt(c * c + l * l) <= (a.o ? 1 : a.Tk)) {
							a.s = h;
							break
						}
					}
		...
		function Rw(a, b) {
			b = b.coordinate;
			a.s = b;
			a.f === Mw ? a.a = b.slice() : a.f === Lw ? (a.a = [[b.slice(), b.slice()]], a.G = a.a[0]) : (a.a = [b.slice(), b.slice()], a.f === Sw && (a.G = a.a));
		...
		function Pw(a, b) {
			...
			if (a.f === Nw) {
				...
				a.f === Lw && (e = a.a[0], e.length >= a.va && (a.o ? e.pop() : d = !0), e.push(b.slice()), d && (a.s = e[0]), a.ab(a.a, c));
			Vw(a);
			d && a.Od()
		}
		k.fq = function () {
		...
		k.Od = function () {
			...
			b = this.a,
			c = a.V();
			this.f === Nw ? (b.pop(), this.ab(b, c)) : this.f === Lw && (b[0].pop(), this.ab(b, c), b = c.U());
			"MultiPoint" === this.O ? a.Ua(new Q([b])) : "MultiLineString" === this.O ? a.Ua(new P([b])) : "MultiPolygon" === this.O && a.Ua(new R([b]));
		...
		function Uw(a) {
			a.s = null;
			var b = a.j;
			b && (a.j = null, a.H = null, a.B = null, a.ua.ia().clear(!0));
			return b
		}
		k.Qn = function (a) {
			var b = a.V();
		...
		function Kw(a) {
			var b;
			"Point" === a || "MultiPoint" === a ? b = Mw : "LineString" === a || "MultiLineString" === a ? b = Nw : "Polygon" === a || "MultiPolygon" === a ? b = Lw : "Circle" === a && (b = Sw);
			return b
		}
		var Mw = "Point",
		Nw = "LineString",
		...
		function Xw(a) {
			...
			this.o = new T({
					...
					style: a.boxStyle ? a.boxStyle : bx(),
		...
		function Yw(a) {
			...
			d = a.map,
			e = this.C();
			(a = dx(this, c, d)) && e ? (c = a[0] == e[0] || a[0] == e[2] ? a[0] : null, d = a[1] == e[1] || a[1] == e[3] ? a[1] : null, null !== c && null !== d ? this.a = fx(b(a)) : null !== c ? this.a = gx(b([c, e[1]]), b([c, e[3]])) : null !== d && (this.a = gx(b([e[0], d]), b([e[2], d])))) : (a = d.Pa(c), this.f([a[0], a[1], a[0], a[1]]), this.a = fx(a));
			return !0
		}
		function Zw(a) {
			this.a && (a = a.coordinate, this.f(this.a(a)), ex(this, a));
			return !0
		}
		function ax() {
			this.a = null;
			var a = this.C();
			a && 0 !== Za(a) || this.f(null);
			return !1
		}
		function bx() {
			var a = uk();
		...
		function dx(a, b, c) {
			...
			if (f) {
				...
				h = c.Ia(g);
				if (Ie(b, h) <= a.B)
					return b = c.Ia(f[0]), c = c.Ia(f[1]), b = He(h, b), c = He(h, c), a.H = Math.sqrt(Math.min(b, c)) <= a.B, a.H && (g = b > c ? f[1] : f[0]), g
			}
			return null
		}
		function ex(a, b) {
		...
		Xw.prototype.setMap = function (a) {
			this.o.setMap(a);
			this.O.setMap(a);
			dh.prototype.setMap.call(this, a)
		};
		...
		function ix(a) {
			...
			this.ca = {
				...
				Polygon: this.Zn,
				MultiPoint: this.Wn,
				MultiLineString: this.Vn,
				MultiPolygon: this.Xn,
				Circle: this.Tn,
				GeometryCollection: this.Un
			};
			this.W = null;
		...
		function px(a, b) {
			a.B || (a.B = !0, a.b(new qx("modifystart", a.o, b)))
		}
		function rx(a, b) {
			sx(a, b);
		...
		k.Ha = function (a) {
			this.f && !a && (this.H.ia().Lb(this.f), this.f = null);
		...
		k.Ii = function (a) {
			this.s || (a = a.target, rx(this, a), this.vg(a))
		};
		k.Sn = function (a) {
			rx(this, a.element)
		};
			...
			if (c) {
				...
				for (var g = 0, h = e.length; g < h; ++g) {
					...
					if ("Circle" === l.geometry.T() && 1 === l.index)
						m = vx(b, l), Ee(m, c) && !f[n][0] && (this.j.push([l, 0]), f[n][0] = l);
						...
						this.rc(a) && w(m)in this.Xa && !f[n][0] && !f[n][1] && d.push([l, c])
				}
				d.length && px(this, a);
				for (a = d.length - 1; 0 <= a; --a)
					this.vm.apply(this, d[a])
			}
			return !!this.f
		}
		function kx(a) {
			...
			for (var b = 0, c = this.j.length; b < c; ++b) {
				...
				case "Circle":
					h[0] = h[1] = a,
					0 === e.index ? (this.s = !0, g.tb(a)) : (this.s = !0, g.ed(Ie(g.wa(), a))),
					this.s = !1
				}
		...
		function mx(a) {
			for (var b, c, d = this.j.length - 1; 0 <= d; --d)
				if (b = this.j[d][0], c = b.geometry, "Circle" === c.T()) {
					...
					lm(this.a, Ba(b.ma), b);
			this.B && (this.b(new qx("modifyend", this.o, a)), this.B = !1);
			return !1
		}
		function lx(a) {
			if (!(a instanceof Ad))
			...
			this.f && this.xb(a) && (b = "singleclick" == a.type && this.G ? !0 : this.yj());
			"singleclick" == a.type && (this.G = !1);
			return eh.call(this, a) && !b
		}
		function ox(a, b, c) {
			function d(a, b) {
				return wx(e, a) - wx(e, b)
			}
			var e = c.Pa(b),
			f = Ea(Oa(e), c.$().Qa() * a.ua);
			f = nm(a.a, f);
		...
		function wx(a, b) {
			var c = b.geometry;
			return "Circle" === c.T() && 1 === b.index ? (a = He(c.wa(), a), c = Math.sqrt(a) - c.zd(), c * c) : Je(a, b.ma)
		}
		function vx(a, b) {
			var c = b.geometry;
			return "Circle" === c.T() && 1 === b.index ? c.Ib(a) : Be(a, b.ma)
		}
		k.vm = function (a, b) {
		...
		k.yj = function () {
			if (this.O && "pointerdrag" != this.O.type) {
				...
				for (h in c) {
					...
					case "Polygon":
						p = p[g.depth[0]],
						4 < p.length && (e == p.length - 1 && (e = 0), p.splice(e, 1), q = !0, 0 === e && (p.pop(), p.push(p[0]), n = p.length - 1))
					}
		...
		function xx(a, b, c, d, e) {
			pm(a.a, b.C(), function (a) {
				a.geometry === b && (void 0 === d || void 0 === a.depth || gc(a.depth, d)) && a.index > c && (a.index += e)
			})
		}
		function nx() {
			var a = uk();
		...
		function zx(a) {
			...
			if (e) {
				kb(this.a);
				f.Sc(a.pixel, function (a, b) {
					if (this.l(a, b))
						return l.push(a), a = w(a), this.a[a] = b, !this.s
				}
					.bind(this), {
					layerFilter: this.o,
					hitTolerance: this.j
				...
				f.Sc(a.pixel, function (a, e) {
					if (this.l(a, e))
						return !b && !d || cc(g.a, a) ? (c || d) && cc(g.a, a) && (h.push(a),
		...
		function Ax() {
			...
			ec(a.GeometryCollection, a.LineString);
			return function (b) {
		...
		function Hx(a, b, c, d) {
			...
			if (0 < g.length) {
				...
				if (a.O && !a.B) {
					...
					a.B && (f = h ? Ae(c, g[0].feature.V()) : Be(c, m), l = d.Ia(f), Ie(b, l) <= a.f && (e = !0, a.O &&
		...
		function Ex(a) {
			var b = Hx(this, a.pixel, a.coordinate, a.map);
			b.Bq && (a.coordinate = b.vertex.slice(0, 2), a.pixel = b.Kq);
			return eh.call(this, a)
		}
		function Fx() {
			var a = lb(this.o);
			a.length && (a.forEach(this.Vj, this), this.o = {});
			return !1
		}
		function Gx(a, b) {
			return Je(this.G, a.ma) - Je(this.G, b.ma)
		};
		function Ix(a) {
			dh.call(this, {
				handleDownEvent: Jx,
		...
		v(Ix, dh);
		function Jx(a) {
			this.f = Nx(this, a.pixel, a.map);
			if (!this.a && this.f) {
				this.a = a.coordinate;
				Lx.call(this, a);
				var b = this.j || new A([this.f]);
				this.b(new Ox("translatestart", b, a.coordinate));
				return !0
			}
			return !1
		}
		function Mx(a) {
			if (this.a) {
				...
				Lx.call(this, a);
				var b = this.j || new A([this.f]);
				this.b(new Ox("translateend", b, a.coordinate));
				return !0
			}
			return !1
		}
		...
		function Nx(a, b, c) {
			return c.Sc(b, function (a) {
				if (!this.j || cc(this.j.a, a))
					return a
			}
				.bind(a), {
				layerFilter: a.B,
		...
		Ix.prototype.setMap = function (a) {
			var b = this.v;
			dh.prototype.setMap.call(this, a);
			Px(this, b)
		};
		...
		k.Ul = function () {
			for (var a = this.Rh(), b = gg(1, 256), c = b.createLinearGradient(0, 0, 1, 256), d = 1 / (a.length - 1), e = 0, f = a.length; e < f; ++e)
		...
		function Yx(a) {
			return 1 === a.length ? a[0] : function (b, c, d) {
				if (b)
					return a[va((b[1] << b[0]) + b[2], a.length)](b, c, d)
			}
		}
		function Zx() {}
		function $x(a) {
		...
		v(by, Zh);
		by.prototype.qd = function (a) {
			for (var b, c; $h(this); ) {
				b = this.g.Nc;
				c = b.xa[0].toString();
				var d;
				if (d = c in a)
					b = b.xa, d = ka(a[c], b[1], b[2]);
				if (d)
					break;
				else
					Pc(this.pop())
		...
		function cy(a) {
			if (0 !== a.i) {
				var b = a.c.ic.split("/").map(Number)[0];
				a.forEach(function (a) {
					if (a.xa[0] !== b) {
						var c = a.xa;
		...
		function dy(a, b, c, d, e, f, g, h, l, m, n) {
			...
			if (0 === Za(f))
				this.state = 4;
			else if ((h = a.C()) && (e ? e = eb(e, h) : e = h), d = fn(a, c, cb(f), d.Sa(this.v[0])), !isFinite(d) || 0 >= d)
				this.state = 4;
			else if (this.o = new jn(a, c, f, e, d * (void 0 !== m ? m : .5)), 0 === this.o.c.length)
				this.state = 4;
			else if (this.f = b.Bc(d), c = ln(this.o), e && (a.g ? (c[1] = oa(c[1], e[1], e[3]),
						c[3] = oa(c[3], e[1], e[3])) : c = eb(c, e)), Za(c)) {
				a = tc(b, c, this.f);
				for (b = a.fa; b <= a.la; b++)
					for (c = a.ea; c <= a.ka; c++)
		...
		v(dy, Tk);
		dy.prototype.ha = function () {
			1 == this.state && (this.Hd.forEach(Gc), this.Hd = null);
			Tk.prototype.ha.call(this)
		};
		dy.prototype.Y = function () {
			return this.P
		};
		dy.prototype.fe = function () {
			var a = [];
			this.a.forEach(function (b) {
				b && 2 == b.getState() && a.push({
					extent: this.c.La(b.xa),
					image: b.Y()
				})
			}, this);
			this.a.length = 0;
				...
				this.a.forEach(function (b) {
					...
					if (0 == c || 1 == c) {
						...
						var d = y(b, "change", function () {
								var c = b.getState();
								if (2 == c || 3 == c || 4 == c)
									Gc(d), a--, 0 === a && (this.Hd.forEach(Gc), this.Hd = null, this.fe())
							}, this);
						this.Hd.push(d)
					}
				}, this);
		...
		function gy(a, b, c) {
			...
			if (c.minZoom > e || e > c.maxZoom)
				...
				var f = c.C();
				c = (c = f ? tc(c, f, e) : c.a ? c.a[e] : null) ? ka(c, d, a) : !0
			}
			return c ? b : null
		}
		k.ra = function () {
		...
		k.aj = function (a) {
			...
			if (1 == c) {
				...
				b in this.W && (delete this.W[b], d = 3 == c ? "tileloaderror" : 2 == c || 5 == c ? "tileloadend" : void 0);
		...
		k.lb = function (a, b) {
			...
			cy(this.a);
			"undefined" !== typeof b ? fy(this, b) : this.u()
		};
		k.qb = function (a) {
			var b = this.urls = $x(a);
		...
		k.Xf = function (a) {
			return this.c && a && !Wb(this.c, a) ? 0 : this.Yf()
		};
		k.Yf = function () {
			return 0
		};
		k.cg = function (a) {
			return this.c && a && !Wb(this.c, a) ? !1 : iy.prototype.cg.call(this, a)
		};
		k.bb = function (a) {
			var b = this.c;
			return !this.tileGrid || b && !Wb(b, a) ? (b = w(a).toString(), b in this.s || (this.s[b] = zc(a)), this.s[b]) : this.tileGrid
		};
		k.Xd = function (a) {
			var b = this.c;
			if (!b || Wb(b, a))
				return this.a;
			a = w(a).toString();
			a in this.f || (this.f[a] = new by(this.a.highWaterMark));
			return this.f[a]
		};
		function ly(a, b, c, d, e, f, g) {
			b = [b, c, d];
		...
		k.$c = function (a, b, c, d, e) {
			...
			if (f && e && !Wb(f, e)) {
				...
				m = this.bb(e),
				n = gy(this, c, e);
				d = new dy(f, l, e, m, c, n, this.Xc(d), this.Yf(), function (a, b, c, d) {
						return my(this, a, b, c, d, f)
					}
						.bind(this), this.xb, this.O);
				d.key = b;
				h ? (d.g = h, Uk(d), g.replace(a, d)) : g.set(a, d);
				return d
			}
			return my(this, a, b, c, d, f || e)
		};
		function my(a, b, c, d, e, f) {
			...
			if (a.a.a.hasOwnProperty(g)) {
				...
				l = ly(a, b, c, d, e, f, h), a.a.set(g, l);
			return l
		}
		k.Qb = function (a) {
			if (this.O != a) {
		...
		k.Rb = function (a, b) {
			if (a = Nb(a))
				a = w(a).toString(), a in this.s || (this.s[a] = b)
		};
		function ky(a, b) {
			a.Y().src = b
		};
		...
		ny.prototype.Xa = function (a) {
			if (200 != a.statusCode || "OK" != a.statusDescription || "ValidCredentials" != a.authenticationResultCode || 1 != a.resourceSets.length || 1 != a.resourceSets[0].resources.length)
				...
				var e = this.o,
				f = this.i;
				this.tileUrlFunction = Yx(c.imageUrlSubdomains.map(function (a) {
							var b = [0, 0, 0],
					...
					this.ta(function (a) {
						...
						c.imageryProviders.map(function (c) {
							for (var e = !1, f = c.coverageAreas, h = 0, l = f.length; h < l; ++h) {
								var m = f[h];
								if (d >= m.zoomMin && d <= m.zoomMax && (m = m.bbox, m = hb([m[1], m[0], m[3], m[2]], g), fb(m, a.extent))) {
									e = !0;
									break
								}
							}
		...
		function ry(a, b) {
			a.qb("https://" + b.cdn_url.https + "/" + a.o + "/api/v1/map/" + b.layergroupid + "/{z}/{x}/{y}.png")
		};
		function Y(a) {
			U.call(this, {
				attributions: a.attributions,
		...
		function sy(a) {
			if (void 0 !== a.resolution) {
				a.features.length = 0;
				for (var b = Ca(), c = a.distance * a.resolution, d = a.source.ce(), e = {}, f = 0, g = d.length; f < g; f++) {
					var h = d[f];
					w(h).toString()in e || !(h = a.geometryFunction(h)) || (h = h.U(), Oa(h, b), Ea(b, c, b), h = a.source.Wf(b), h = h.filter(function (a) {
								a = w(a).toString();
								return a in e ? !1 : e[a] = !0
							}), a.features.push(ty(a, h)))
				}
			}
		}
		function ty(a, b) {
		...
		k.Vc = function (a, b, c, d) {
			...
			c = this.aa ? c : 1;
			var e = this.N;
			if (e && this.O == this.g && e.resolution == b && e.a == c && Ka(e.C(), a))
				return e;
			e = {
				F: "image",
				FORMAT: "PNG32",
		...
		k.Vc = function (a, b, c) {
			...
			c = this.aa ? c : 1;
			var d = this.N;
			if (d && this.G == this.g && d.resolution == b && d.a == c && Ka(d.C(), a))
				return d;
		...
		v(xy, qn);
		xy.prototype.Vc = function (a) {
			return fb(a, this.N.C()) ? this.N : null
		};
		xy.prototype.j = function (a) {
		...
		k.Vc = function (a, b, c, d) {
			...
			if ((f = this.N) && this.W == this.g && f.resolution == b && f.a == c && Ka(f.C(), g))
				return f;
			g = {
				SERVICE: "WMS",
				VERSION: "1.3.0",
		...
		(function (a) {
			...
			function f(a) {
				...
				if (b)
					for (var f = 0; f < b; ++f)
						c[f] = d(a, this.wh.bind(this, f));
				else
					c[0] = e(a, this.wh.bind(this,
								0));
				this.ve = c;
				this.Md = [];
			...
			f.prototype.uk = function (a) {
				for (this.Md.push(a); this.Md.length > this.wk; )
					this.Md.shift().callback(null, null)
			};
				...
				if (0 === this.ue && 0 < this.Md.length) {
					...
					if (1 === e)
						...
						for (var f = 4 * Math.ceil(a.inputs[0].data.length / 4 / e), g = 0; g < e; ++g) {
							for (var h = g * f, C = [], z = 0, E = d.length; z < E; ++z)
								C.push(d[g].slice(h, h + f));
							this.ve[g].postMessage({
								buffers: C,
								meta: a.fi,
								imageOps: this.Hf,
								width: b,
			...
			f.prototype.wh = function (a, b) {
				this.Xq || (this.md[a] = b.data, --this.ue, 0 === this.ue && this.xk())
			};
			f.prototype.xk = function () {
				...
				c = this.ve.length;
				if (1 === c) {
					var d = new Uint8ClampedArray(this.md[0].buffer);
					var e = this.md[0].meta
				} else {
		...
		Dy.prototype.Y = function (a, b, c, d) {
			...
			for (var e, f = 0, g = this.f.length; f < g; ++f)
				if (e = this.f[f].a.ia(), "ready" !== e.getState()) {
					c = !1;
					break
				}
			if (!c)
				...
				a: {
					...
					for (e = 0; e < d; ++e) {
						...
						if (f.Cd(g, h)) {
							...
							if (Gy) {
								var n = Gy.canvas;
								n.width !== l || n.height !== m ? Gy = gg(l, m) : Gy.clearRect(0, 0, l, m)
							} else
								Gy = gg(l, m);
							f.xg(g, h, Gy);
							f = Gy.getImageData(0, 0, l, m)
						} else
							f = null;
						if (f)
							b[e] = f;
					...
					d = {};
					this.b(new Hy(Iy, a, d));
					this.G.Ip(b, d, this.ca.bind(this, a))
				}
		...
		Dy.prototype.ca = function (a, b, c, d) {
			if (!b && c) {
				...
				if (e === this.l.viewState.resolution && Ra(b, this.l.extent)) {
					if (this.a)
						var f = this.a.Y().getContext("2d");
					else
						f = gg(Math.round(ab(b) / e), Math.round(bb(b) / e)), this.a = new en(b, e, 1, f.canvas);
		...
		function Ey(a) {
			for (var b = a.length, c = Array(b), d = 0; d < b; ++d) {
				...
				f = a[d],
				g = null;
				f instanceof ey ? (f = new Vx({
							source: f
						}), g = new bj(f)) : f instanceof qn && (f = new Ux({
							source: f
						}), g = new Si(f));
				c[e] = g
			}
		...
		function Ky(a) {
			...
			b = Ly[-1 == b ? a.layer : a.layer.slice(0, b)];
			var c = My[a.layer];
			oy.call(this, {
				attributions: Ny,
				cacheSize: a.cacheSize,
		...
		v(Qy, ey);
		Qy.prototype.$c = function (a, b, c) {
			var d = a + "/" + b + "/" + c;
			if (this.a.a.hasOwnProperty(d))
				return this.a.get(d);
			var e = Aa(this.tileGrid.Za(a));
			a = [a, b, c];
		...
		Ry.prototype.Y = function () {
			...
			b.fillText(this.sa, a[0] / 2, a[1] / 2);
		...
		function Sy(a) {
			...
			if (a.url)
				if (a.jsonp)
					ay(a.url, this.Bg.bind(this), this.cf.bind(this));
				else {
				...
				a.tileJSON ? this.Bg(a.tileJSON) : na(!1, 51)
		}
		v(Sy, jy);
		k = Sy.prototype;
		k.To = function (a) {
		...
		k.Bg = function (a) {
			...
			this.tileUrlFunction = Xx(a.tiles, c);
			if (void 0 !== a.attribution && !this.B) {
				var g = void 0 !== d ? d : b.C();
				this.ta(function (b) {
					return fb(g, b.extent) ? [a.attribution] : null
				})
			}
			this.i = a;
			pn(this, "ready")
		...
		function Ty(a) {
			...
			if (a.url)
				if (this.i)
					ay(a.url, this.Cg.bind(this), this.df.bind(this));
				else {
					var b = new XMLHttpRequest;
				...
				a.tileJSON ? this.Cg(a.tileJSON) : na(!1, 51)
		}
		v(Ty, ey);
		k = Ty.prototype;
		k.Xo = function (a) {
		...
		k.Wk = function (a, b, c, d, e) {
			this.tileGrid ? (b = this.tileGrid.Ke(a, b), Uy(this.$c(b[0], b[1], b[2], 1, this.c), a, c, d, e)) : !0 === e ? setTimeout(function () {
				c.call(d, null)
			}, 0) : c.call(d, null)
		};
		k.df = function () {
		...
		function Uy(a, b, c, d, e) {
			0 == a.state && !0 === e ? (Lc(a, "change", function () {
				...
				}, a), Wy(a)) : !0 === e ? setTimeout(function () {
				c.call(d, this.getData(b))
			}
		...
		function Wy(a) {
			if (0 == a.state)
				if (a.state = 1, a.o)
					ay(a.v, a.Zi.bind(a), a.Me.bind(a));
				else {
					var b = new XMLHttpRequest;
		...
		k.Xc = function (a) {
			return this.aa && void 0 !== this.G ? a : 1
		};
		function Zy(a) {
			var b = 0,
			c = [],
		...
		k.Rc = function (a, b, c) {
			...
			d || (d = this.bb(c));
			if (!(d.b.length <= a[0])) {
				1 == b || this.aa && void 0 !== this.G || (b = 1);
				var e = d.Sa(a[0]),
				f = d.La(a, this.ca);
				d = Aa(d.Za(a[0]), this.j);
				var g = this.o;
		...
		function az(a, b, c, d, e, f, g, h, l, m, n, p, q, r, u) {
			Tk.call(this, a, b, u);
			this.v = {};
			this.o = {};
			this.c = m;
			...
			if (f) {
				var x = l.La(f),
				C = l.Sa(a[0]);
				h.Tf(x, h.Bc(C), function (a) {
					var b = eb(x, h.La(a)),
					c = h.C();
					c && (b = eb(b, c));
					.5 <= ab(b) / C && .5 <= bb(b) / C && (b = a.toString(), c = m[b], c || (c = g(a, n, p), c = m[b] = new q(a, void 0 == c ? 4 : 0, void 0 == c ? "" : c, d, e), this.P.push(y(c, "change", r))), c.c++, this.a.push(b))
				}
					.bind(this))
			}
		}
		...
		k.Y = function (a) {
			return -1 == ak(this, a).eh ? null : bk(this, a).canvas
		};
		function ak(a, b) {
			b = w(b).toString();
			b in a.o || (a.o[b] = {
		...
		function bz(a, b) {
			a.sg(Po(b, a.v, a.tp.bind(a), a.sp.bind(a)))
		};
		function cz(a) {
			...
			iy.call(this, {
				...
				state: a.state,
				tileGrid: d,
				tileLoadFunction: a.tileLoadFunction ? a.tileLoadFunction : bz,
				tileUrlFunction: a.tileUrlFunction,
				url: a.url,
				urls: a.urls,
		...
		function Z(a) {
			function b(a) {
				a = "KVP" == d ? uy(a, f) : a.replace(/\{(\w+?)\}/g, function (a, b) {
				...
				return function (b) {
					if (b) {
						...
						jb(c, g);
						b = a;
						return b = "KVP" == d ? uy(b, c) : b.replace(/\{(\w+?)\}/g, function (a, b) {
								return c[b]
							})
					}
				}
		...
		v(gz, jy);
		function jz(a, b, c, d, e, f, g) {
			Vk.call(this, b, c, d, e, f, g);
			this.a = null;
			this.v = Aa(a.Za(b[0]))
		}
		v(jz, Vk);
		jz.prototype.Y = function () {
			if (this.a)
				return this.a;
			var a = Vk.prototype.Y.call(this);
			if (2 == this.state) {
				var b = this.v;
		...
		t("ol.proj.fromLonLat", function (a, b) {
			return Zb(a, "EPSG:4326", void 0 !== b ? b : "EPSG:3857")
		});
		t("ol.proj.toLonLat", function (a, b) {
			a = Zb(a, void 0 !== b ? b : "EPSG:3857", "EPSG:4326");
			b = a[0];
			if (-180 > b || 180 < b)
				a[0] = va(b + 180, 360) - 180;
			return a
		});
		t("ol.proj.get", Nb);
		...
		t("ol.source.WMTS.optionsFromCapabilities", function (a, b) {
			var c = fc(a.Contents.Layer, function (a) {
			...
			var m = fc(a.Contents.TileMatrixSet, function (a) {
			...
			if (void 0 !== p) {
				var q = Nb("EPSG:4326").C();
				q = p[0] == q[0] && p[2] == q[2];
				var r = $b(p, "EPSG:4326", n);
			...
			if ("OperationsMetadata" in a && "GetTile" in a.OperationsMetadata)
				for (a = a.OperationsMetadata.GetTile.DCP.HTTP.Get, r = 0, p = a.length; r < p; ++r) {
					var x = fc(a[r].Constraint, function (a) {
							return "GetEncoding" == a.name
						}).AllowedValues.Value;
					"" === m && (m = x[0]);
					if ("KVP" === m)
						cc(x, "KVP") && u.push(a[r].href);
					else
						break
				}
		...
		t("ol.interaction.Draw.createRegularPolygon", function (a, b) {
			return function (c, d) {
				...
				d = d ? d : Tf(new lw(e), a);
				Xf(d, e, f, b ? b : Math.atan((c[1] - e[1]) / (c[0] - e[0])));
				return d
			}
		});
		...
		t("ol.format.filter.or", function (a) {
			var b = [null].concat(Array.prototype.slice.call(arguments));
			return new(Function.prototype.bind.apply(du, b))
		});
		...
		t("ol.format.WFS.writeFilter", function (a) {
			var b = yo("http://www.opengis.net/ogc", "Filter");
			Oo({
				node: b
			}, Ju, Jo(a.qc), [a], []);
			return b
